python WLK_experiment.py --packer_name aspack --file_name accesschk.exe
python WLK_experiment.py --packer_name aspack --file_name AccessEnum.exe
python WLK_experiment.py --packer_name aspack --file_name ADExplorer.exe
python WLK_experiment.py --packer_name aspack --file_name ADInsight.exe
python WLK_experiment.py --packer_name aspack --file_name  adrestore.exe
python WLK_experiment.py --packer_name aspack --file_name  Autologon.exe
python WLK_experiment.py --packer_name aspack --file_name BatteryInfoView.exe
python WLK_experiment.py --packer_name aspack --file_name Bginfo.exe
python WLK_experiment.py --packer_name aspack --file_name BlueScreenView.exe
python WLK_experiment.py --packer_name aspack --file_name Cacheset.exe
python WLK_experiment.py --packer_name aspack --file_name Clockres.exe
python WLK_experiment.py --packer_name aspack --file_name ComIntRep.exe
python WLK_experiment.py --packer_name aspack --file_name Contig.exe
python WLK_experiment.py --packer_name aspack --file_name Coreinfo.exe
python WLK_experiment.py --packer_name aspack --file_name ctrl2cap.exe
python WLK_experiment.py --packer_name aspack --file_name Dbgview.exe
python WLK_experiment.py --packer_name aspack --file_name Desktops.exe
python WLK_experiment.py --packer_name aspack --file_name disk2vhd.exe
python WLK_experiment.py --packer_name aspack --file_name diskext.exe
python WLK_experiment.py --packer_name aspack --file_name Diskmon.exe
python WLK_experiment.py --packer_name aspack --file_name DiskView.exe
python WLK_experiment.py --packer_name aspack --file_name DriverView.exe
python WLK_experiment.py --packer_name aspack --file_name du.exe
python WLK_experiment.py --packer_name aspack --file_name dxwebsetup.exe
python WLK_experiment.py --packer_name aspack --file_name efsdump.exe
python WLK_experiment.py --packer_name aspack --file_name ESEDatabaseView.exe
python WLK_experiment.py --packer_name aspack --file_name EventLogChannelsView.exe
python WLK_experiment.py --packer_name aspack --file_name FastHash_kr.exe
python WLK_experiment.py --packer_name aspack --file_name FileTypesMan.exe
python WLK_experiment.py --packer_name aspack --file_name FindLinks.exe
python WLK_experiment.py --packer_name aspack --file_name FolderTimeUpdate.exe
python WLK_experiment.py --packer_name aspack --file_name FullEventLogView.exe
python WLK_experiment.py --packer_name aspack --file_name geek.exe
python WLK_experiment.py --packer_name aspack --file_name grepWin-1.9.0_portable.exe
python WLK_experiment.py --packer_name aspack --file_name handle.exe
python WLK_experiment.py --packer_name aspack --file_name HashCalc.exe
python WLK_experiment.py --packer_name aspack --file_name Hasher.exe
python WLK_experiment.py --packer_name aspack --file_name Hash.exe
