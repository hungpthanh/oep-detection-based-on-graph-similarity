...
0x0040fe6f:	addl %esp, $0xc<UINT8>
0x0040fe72:	movl %eax, %esi
0x0040fe74:	popl %esi
0x0040fe75:	ret

0x0040fe80:	andl (%esi), $0x0<UINT8>
0x0040fe83:	leal %ecx, 0x10(%esi)
0x0040fe86:	movl 0x4(%esi), $0x400000<UINT32>
0x0040fe8d:	movl 0x8(%esi), $0x422da0<UINT32>
0x0040fe94:	movl 0xc(%esi), $0x422da0<UINT32>
0x0040fe9b:	call 0x0040bf90
0x0040fea0:	testl %eax, %eax
0x0040fea2:	jns 0x0040fead
0x0040fead:	movl (%esi), $0x28<UINT32>
0x0040feb3:	movl %eax, %esi
0x0040feb5:	popl %esi
0x0040feb6:	ret

0x0041d380:	pushl $0x41d5cb<UINT32>
0x0041d385:	call 0x00411c7a
0x0041d38a:	popl %ecx
0x0041d38b:	ret

0x0041d320:	movl %ecx, $0x4253f0<UINT32>
0x0041d325:	call 0x0040c010
0x0040c010:	pushl %esi
0x0040c011:	movl %esi, %ecx
0x0040c013:	leal %eax, 0x10(%esi)
0x0040c016:	xorl %ecx, %ecx
0x0040c018:	movl (%eax), %ecx
0x0040c01a:	movl 0x4(%eax), %ecx
0x0040c01d:	movl 0x8(%eax), %ecx
0x0040c020:	movl 0xc(%eax), %ecx
0x0040c023:	movl 0x10(%eax), %ecx
0x0040c026:	pushl %edi
0x0040c027:	xorl %edi, %edi
0x0040c029:	movl 0x14(%eax), %ecx
0x0040c02c:	pushl %edi
0x0040c02d:	movl 0x4(%esi), %edi
0x0040c030:	movl 0xc(%esi), %edi
0x0040c033:	movl 0x8(%esi), %edi
0x0040c036:	movl 0x4253c4, %esi
0x0040c03c:	pushl %eax
0x0040c03d:	movl 0x28(%esi), %edi
0x0040c040:	call InitializeCriticalSectionAndSpinCount@KERNEL32.dll
0x0040c046:	testl %eax, %eax
0x0040c048:	jne 0x0040c06e
0x0040c06e:	popl %edi
0x0040c06f:	movl 0x4(%esi), $0x24<UINT32>
0x0040c076:	movl %eax, %esi
0x0040c078:	popl %esi
0x0040c079:	ret

0x0041d32a:	pushl $0x41d550<UINT32>
0x0041d32f:	movl 0x4253c8, $0x4253f0<UINT32>
0x0041d339:	movl 0x4253f0, $0x41f21c<UINT32>
0x0041d343:	call 0x00411c7a
0x0041d348:	popl %ecx
0x0041d349:	ret

0x0041d0d0:	pushl $0x41d390<UINT32>
0x0041d0d5:	call 0x00411c7a
0x0041d0da:	popl %ecx
0x0041d0db:	ret

0x0041d0e0:	pushl %ebx
0x0041d0e1:	pushl %esi
0x0041d0e2:	pushl $0x41f2fc<UINT32>
0x0041d0e7:	movl %ebx, $0x421488<UINT32>
0x0041d0ec:	movl %esi, $0x4262a8<UINT32>
0x0041d0f1:	call 0x004023b0
0x004023b0:	pushl %ebp
0x004023b1:	movl %ebp, %esp
0x004023b3:	movl %eax, %ebx
0x004023b5:	leal %edx, 0x2(%eax)
0x004023b8:	jmp 0x004023c0
0x004023c0:	movw %cx, (%eax)
0x004023c3:	addl %eax, $0x2<UINT8>
0x004023c6:	testw %cx, %cx
0x004023c9:	jne 0x004023c0
0x004023cb:	subl %eax, %edx
0x004023cd:	sarl %eax
0x004023cf:	pushl %edi
0x004023d0:	movl %edi, %eax
0x004023d2:	cmpl %edi, $0x10<UINT8>
0x004023d5:	jb 0x004023e6
0x004023e6:	leal %eax, 0x1c(%esi)
0x004023e9:	incl %edi
0x004023ea:	movl 0x10(%esi), %eax
0x004023ed:	xorl %ecx, %ecx
0x004023ef:	movl 0x14(%esi), $0x0<UINT32>
0x004023f6:	movl 0x18(%esi), %edi
0x004023f9:	movw (%eax), %cx
0x004023fc:	movl %eax, %ebx
0x004023fe:	leal %edx, 0x2(%eax)
0x00402401:	movw %cx, (%eax)
0x00402404:	addl %eax, $0x2<UINT8>
0x00402407:	testw %cx, %cx
0x0040240a:	jne 0x00402401
0x0040240c:	subl %eax, %edx
0x0040240e:	sarl %eax
0x00402410:	movl %edi, %eax
0x00402412:	movl %eax, 0x10(%esi)
0x00402415:	leal %edx, (%edi,%edi)
0x00402418:	pushl %edx
0x00402419:	pushl %ebx
0x0040241a:	pushl %eax
0x0040241b:	call 0x00410610
0x00410690:	jmp 0x0041075c
0x00410754:	movl %eax, -12(%esi,%ecx,4)
0x00410758:	movl -12(%edi,%ecx,4), %eax
0x0041075c:	movl %eax, -8(%esi,%ecx,4)
0x00410760:	movl -8(%edi,%ecx,4), %eax
0x00410764:	movl %eax, -4(%esi,%ecx,4)
0x00410768:	movl -4(%edi,%ecx,4), %eax
0x0041076c:	leal %eax, (,%ecx,4)
0x00410773:	addl %esi, %eax
0x00410775:	addl %edi, %eax
0x00410777:	jmp 0x004107a4
...
0x00402420:	movl %eax, 0x18(%esi)
0x00402423:	addl %esp, $0xc<UINT8>
0x00402426:	movl %ecx, %edi
0x00402428:	cmpl %edi, %eax
0x0040242a:	popl %edi
0x0040242b:	jb 0x00402430
0x00402430:	testl %eax, %eax
0x00402432:	jne 0x00402438
0x00402438:	movl %edx, 0x10(%esi)
0x0040243b:	xorl %eax, %eax
0x0040243d:	movw (%edx,%ecx,2), %ax
0x00402441:	movl %eax, 0x8(%ebp)
0x00402444:	movl 0x14(%esi), %ecx
0x00402447:	testl %eax, %eax
0x00402449:	je 28
0x0040244b:	movl %ecx, (%eax)
0x0040244d:	movl (%esi), %ecx
0x0040244f:	movl %edx, 0x4(%eax)
0x00402452:	movl 0x4(%esi), %edx
0x00402455:	movl %ecx, 0x8(%eax)
0x00402458:	movl 0x8(%esi), %ecx
0x0040245b:	movl %edx, 0xc(%eax)
0x0040245e:	movl 0xc(%esi), %edx
0x00402461:	movl %eax, %esi
0x00402463:	popl %ebp
0x00402464:	ret $0x4<UINT16>

0x0041d0f6:	pushl $0x41d3d0<UINT32>
0x0041d0fb:	call 0x00411c7a
0x0041d100:	addl %esp, $0x4<UINT8>
0x0041d103:	popl %esi
0x0041d104:	popl %ebx
0x0041d105:	ret

0x0041d110:	pushl %ebx
0x0041d111:	pushl %esi
0x0041d112:	pushl $0x41f30c<UINT32>
0x0041d117:	movl %ebx, $0x421498<UINT32>
0x0041d11c:	movl %esi, $0x4262e4<UINT32>
0x0041d121:	call 0x004023b0
0x0041d126:	pushl $0x41d3f0<UINT32>
0x0041d12b:	call 0x00411c7a
0x0041d130:	addl %esp, $0x4<UINT8>
0x0041d133:	popl %esi
0x0041d134:	popl %ebx
0x0041d135:	ret

0x0041d140:	pushl %ebx
0x0041d141:	pushl %esi
0x0041d142:	pushl $0x41f31c<UINT32>
0x0041d147:	movl %ebx, $0x4214a4<UINT32>
0x0041d14c:	movl %esi, $0x426320<UINT32>
0x0041d151:	call 0x004023b0
0x0041074c:	movl %eax, -16(%esi,%ecx,4)
0x00410750:	movl -16(%edi,%ecx,4), %eax
0x0041d156:	pushl $0x41d410<UINT32>
0x0041d15b:	call 0x00411c7a
0x0041d160:	addl %esp, $0x4<UINT8>
0x0041d163:	popl %esi
0x0041d164:	popl %ebx
0x0041d165:	ret

0x0041d170:	pushl %ebx
0x0041d171:	pushl %esi
0x0041d172:	pushl $0x41f32c<UINT32>
0x0041d177:	movl %ebx, $0x4214b8<UINT32>
0x0041d17c:	movl %esi, $0x42635c<UINT32>
0x0041d181:	call 0x004023b0
0x0041d186:	pushl $0x41d430<UINT32>
0x0041d18b:	call 0x00411c7a
0x0041d190:	addl %esp, $0x4<UINT8>
0x0041d193:	popl %esi
0x0041d194:	popl %ebx
0x0041d195:	ret

0x0041d1a0:	pushl %ebx
0x0041d1a1:	pushl %esi
0x0041d1a2:	pushl $0x41f33c<UINT32>
0x0041d1a7:	movl %ebx, $0x4214c0<UINT32>
0x0041d1ac:	movl %esi, $0x426398<UINT32>
0x0041d1b1:	call 0x004023b0
0x0041d1b6:	pushl $0x41d450<UINT32>
0x0041d1bb:	call 0x00411c7a
0x0041d1c0:	addl %esp, $0x4<UINT8>
0x0041d1c3:	popl %esi
0x0041d1c4:	popl %ebx
0x0041d1c5:	ret

0x0041d1d0:	pushl %ebx
0x0041d1d1:	pushl %esi
0x0041d1d2:	pushl $0x41f34c<UINT32>
0x0041d1d7:	movl %ebx, $0x4214d4<UINT32>
0x0041d1dc:	movl %esi, $0x4263d4<UINT32>
0x0041d1e1:	call 0x004023b0
0x0041d1e6:	pushl $0x41d470<UINT32>
0x0041d1eb:	call 0x00411c7a
0x0041d1f0:	addl %esp, $0x4<UINT8>
0x0041d1f3:	popl %esi
0x0041d1f4:	popl %ebx
0x0041d1f5:	ret

0x0041d200:	pushl %ebx
0x0041d201:	pushl %esi
0x0041d202:	pushl $0x41f2fc<UINT32>
0x0041d207:	movl %ebx, $0x421488<UINT32>
0x0041d20c:	movl %esi, $0x426410<UINT32>
0x0041d211:	call 0x004023b0
0x0041d216:	pushl $0x41d490<UINT32>
0x0041d21b:	call 0x00411c7a
0x0041d220:	addl %esp, $0x4<UINT8>
0x0041d223:	popl %esi
0x0041d224:	popl %ebx
0x0041d225:	ret

0x0041d230:	pushl %ebx
0x0041d231:	pushl %esi
0x0041d232:	pushl $0x41f30c<UINT32>
0x0041d237:	movl %ebx, $0x421498<UINT32>
0x0041d23c:	movl %esi, $0x42644c<UINT32>
0x0041d241:	call 0x004023b0
0x0041d246:	pushl $0x41d4b0<UINT32>
0x0041d24b:	call 0x00411c7a
0x0041d250:	addl %esp, $0x4<UINT8>
0x0041d253:	popl %esi
0x0041d254:	popl %ebx
0x0041d255:	ret

0x0041d260:	pushl %ebx
0x0041d261:	pushl %esi
0x0041d262:	pushl $0x41f31c<UINT32>
0x0041d267:	movl %ebx, $0x4214a4<UINT32>
0x0041d26c:	movl %esi, $0x426488<UINT32>
0x0041d271:	call 0x004023b0
0x0041d276:	pushl $0x41d4d0<UINT32>
0x0041d27b:	call 0x00411c7a
0x0041d280:	addl %esp, $0x4<UINT8>
0x0041d283:	popl %esi
0x0041d284:	popl %ebx
0x0041d285:	ret

0x0041d290:	pushl %ebx
0x0041d291:	pushl %esi
0x0041d292:	pushl $0x41f32c<UINT32>
0x0041d297:	movl %ebx, $0x4214b8<UINT32>
0x0041d29c:	movl %esi, $0x4264c4<UINT32>
0x0041d2a1:	call 0x004023b0
0x0041d2a6:	pushl $0x41d4f0<UINT32>
0x0041d2ab:	call 0x00411c7a
0x0041d2b0:	addl %esp, $0x4<UINT8>
0x0041d2b3:	popl %esi
0x0041d2b4:	popl %ebx
0x0041d2b5:	ret

0x0041d2c0:	pushl %ebx
0x0041d2c1:	pushl %esi
0x0041d2c2:	pushl $0x41f33c<UINT32>
0x0041d2c7:	movl %ebx, $0x4214c0<UINT32>
0x0041d2cc:	movl %esi, $0x426500<UINT32>
0x0041d2d1:	call 0x004023b0
0x0041d2d6:	pushl $0x41d510<UINT32>
0x0041d2db:	call 0x00411c7a
0x0041d2e0:	addl %esp, $0x4<UINT8>
0x0041d2e3:	popl %esi
0x0041d2e4:	popl %ebx
0x0041d2e5:	ret

0x0041d2f0:	pushl %ebx
0x0041d2f1:	pushl %esi
0x0041d2f2:	pushl $0x41f34c<UINT32>
0x0041d2f7:	movl %ebx, $0x4214d4<UINT32>
0x0041d2fc:	movl %esi, $0x42653c<UINT32>
0x0041d301:	call 0x004023b0
0x0041d306:	pushl $0x41d530<UINT32>
0x0041d30b:	call 0x00411c7a
0x0041d310:	addl %esp, $0x4<UINT8>
0x0041d313:	popl %esi
0x0041d314:	popl %ebx
0x0041d315:	ret

0x00412621:	cmpl 0x4266b8, $0x0<UINT8>
0x00412628:	popl %edi
0x00412629:	popl %esi
0x0041262a:	je 0x00412647
0x00412647:	xorl %eax, %eax
0x00412649:	popl %ebp
0x0041264a:	ret

0x004120ea:	popl %ecx
0x004120eb:	cmpl %eax, %esi
0x004120ed:	je 0x004120f6
0x004120f6:	call 0x0041785d
0x0041785d:	movl %eax, 0x4266bc
0x00417862:	xorl %edx, %edx
0x00417864:	testl %eax, %eax
0x00417866:	jne 0x0041786d
0x0041786d:	movzwl %ecx, (%eax)
0x00417870:	cmpl %ecx, $0x20<UINT8>
0x00417873:	ja 0x0041787e
0x0041787e:	cmpl %ecx, $0x22<UINT8>
0x00417881:	jne 0x0041788c
0x00417883:	xorl %ecx, %ecx
0x00417885:	testl %edx, %edx
0x00417887:	sete %cl
0x0041788a:	movl %edx, %ecx
0x0041788c:	addl %eax, $0x2<UINT8>
0x0041788f:	jmp 0x0041786d
0x00417875:	testw %cx, %cx
0x00417878:	je 0x004178a2
0x004178a2:	ret

0x004120fb:	testb -60(%ebp), $0x1<UINT8>
0x004120ff:	je 0x00412107
0x00412107:	pushl $0xa<UINT8>
0x00412109:	popl %ecx
0x0041210a:	pushl %ecx
0x0041210b:	pushl %eax
0x0041210c:	pushl %esi
0x0041210d:	pushl $0x400000<UINT32>
0x00412112:	call 0x0040f7d0
0x0040f7d0:	pushl %ebp
0x0040f7d1:	movl %ebp, %esp
0x0040f7d3:	subl %esp, $0xa4<UINT32>
0x0040f7d9:	movl %eax, 0x424308
0x0040f7de:	xorl %eax, %ebp
0x0040f7e0:	movl -4(%ebp), %eax
0x0040f7e3:	pushl %ebx
0x0040f7e4:	pushl %esi
0x0040f7e5:	pushl %edi
0x0040f7e6:	leal %eax, -52(%ebp)
0x0040f7e9:	xorl %ebx, %ebx
0x0040f7eb:	pushl %eax
0x0040f7ec:	movl -52(%ebp), %ebx
0x0040f7ef:	call GetCommandLineW@KERNEL32.dll
0x0040f7f5:	pushl %eax
0x0040f7f6:	call CommandLineToArgvW@SHELL32.dll
CommandLineToArgvW@SHELL32.dll: API Node	
0x0040f7fc:	cmpl -52(%ebp), $0x1<UINT8>
0x0040f800:	movl %edi, %eax
0x0040f802:	jle 0x0040f9db
0x0040f9db:	pushl %ebx
0x0040f9dc:	call CoInitialize@ole32.dll
CoInitialize@ole32.dll: API Node	
0x0040f9e2:	pushl %ebx
0x0040f9e3:	pushl %ebx
0x0040f9e4:	pushl %ebx
0x0040f9e5:	pushl %ebx
0x0040f9e6:	call DefWindowProcW@USER32.dll
DefWindowProcW@USER32.dll: API Node	
0x0040f9ec:	leal %eax, -68(%ebp)
0x0040f9ef:	pushl %eax
0x0040f9f0:	movl -68(%ebp), $0x8<UINT32>
0x0040f9f7:	movl -64(%ebp), $0x4<UINT32>
0x0040f9fe:	call InitCommonControlsEx@COMCTL32.dll
InitCommonControlsEx@COMCTL32.dll: API Node	
0x0040fa04:	pushl $0x41ef24<UINT32>
0x0040fa09:	call GetModuleHandleW@KERNEL32.dll
0x0040fa0f:	pushl $0x41ef08<UINT32>
0x0040fa14:	pushl %eax
0x0040fa15:	call GetProcAddress@KERNEL32.dll
0x0040fa1b:	movl %esi, %eax
0x0040fa1d:	cmpl %esi, %ebx
0x0040fa1f:	je 21
0x0040fa21:	pushl $0x1<UINT8>
0x0040fa23:	pushl $0x233<UINT32>
0x0040fa28:	call ChangeWindowMessageFilter@user32.dll
ChangeWindowMessageFilter@user32.dll: API Node	
0x0040fa2a:	pushl $0x1<UINT8>
0x0040fa2c:	pushl $0x4a<UINT8>
0x0040fa2e:	call ChangeWindowMessageFilter@user32.dll
0x0040fa30:	pushl $0x1<UINT8>
0x0040fa32:	pushl $0x49<UINT8>
0x0040fa34:	call ChangeWindowMessageFilter@user32.dll
0x0040fa36:	movl %esi, 0x42549c
0x0040fa3c:	movl 0x42541c, %ebx
0x0040fa42:	cmpl %esi, 0x4254a0
0x0040fa48:	jae 0x0040fa68
0x0040fa68:	call GetCurrentThreadId@KERNEL32.dll
0x0040fa6e:	pushl $0xc<UINT8>
0x0040fa70:	movl 0x425420, %eax
0x0040fa75:	movl 0x425424, %ebx
0x0040fa7b:	call 0x0041053a
0x0041053a:	movl %edi, %edi
0x0041053c:	pushl %ebp
0x0041053d:	movl %ebp, %esp
0x0041053f:	subl %esp, $0x10<UINT8>
0x00410542:	jmp 0x00410551
0x00410551:	pushl 0x8(%ebp)
0x00410554:	call 0x0041018b
0x00410559:	popl %ecx
0x0041055a:	testl %eax, %eax
0x0041055c:	je -26
0x0041055e:	leave
0x0041055f:	ret

0x0040fa80:	addl %esp, $0x4<UINT8>
0x0040fa83:	cmpl %eax, %ebx
0x0040fa85:	je 173
0x0040fa8b:	movl (%eax), %ebx
0x0040fa8d:	movl 0x4(%eax), %ebx
0x0040fa90:	movl 0x8(%eax), %ebx
0x0040fa93:	movl 0x425424, %eax
0x0040fa98:	movl 0x425428, %ebx
0x0040fa9e:	orl %eax, $0xffffffff<UINT8>
0x0040faa1:	pushl %ebx
0x0040faa2:	movl -160(%ebp), %ebx
0x0040faa8:	movl -144(%ebp), %ebx
0x0040faae:	movl -140(%ebp), %ebx
0x0040fab4:	movl -136(%ebp), %ebx
0x0040faba:	movl -132(%ebp), %ebx
0x0040fac0:	movl -128(%ebp), %ebx
0x0040fac3:	movl -124(%ebp), %ebx
0x0040fac6:	movb -104(%ebp), %bl
0x0040fac9:	movl -120(%ebp), %ebx
0x0040facc:	movl -116(%ebp), %ebx
0x0040facf:	movl -112(%ebp), %eax
0x0040fad2:	movl -108(%ebp), %eax
0x0040fad5:	movl -164(%ebp), $0x41f284<UINT32>
0x0040fadf:	movl -100(%ebp), %ebx
0x0040fae2:	movl -96(%ebp), %ebx
0x0040fae5:	movl -92(%ebp), %ebx
0x0040fae8:	movl -88(%ebp), %ebx
0x0040faeb:	movl -84(%ebp), %ebx
0x0040faee:	movl -80(%ebp), %ebx
0x0040faf1:	movl -76(%ebp), %ebx
0x0040faf4:	call GetActiveWindow@USER32.dll
GetActiveWindow@USER32.dll: API Node	
0x0040fafa:	pushl %eax
0x0040fafb:	leal %ecx, -164(%ebp)
0x0040fb01:	call 0x0040e4d0
0x0040e4d0:	pushl %ebp
0x0040e4d1:	movl %ebp, %esp
0x0040e4d3:	pushl %esi
0x0040e4d4:	movl %esi, %ecx
0x0040e4d6:	cmpl 0x14(%esi), $0x0<UINT8>
0x0040e4da:	jne 16
0x0040e4dc:	call 0x0040fd0a
0x0040fd0a:	jmp 0x0040fc6c
0x0040fc6c:	cmpl 0x425464, $0x0<UINT8>
0x0040fc73:	pushl %esi
0x0040fc74:	pushl %edi
0x0040fc75:	jne 9
0x0040fc77:	call 0x0040fbec
0x0040fbec:	pushl $0xc<UINT8>
0x0040fbee:	call IsProcessorFeaturePresent@KERNEL32.dll
0x0040fbf4:	testl %eax, %eax
0x0040fbf6:	jne 0x0040fbff
0x0040fbff:	movl %eax, %fs:0x18
0x0040fc05:	pushl %ebx
0x0040fc06:	pushl %esi
0x0040fc07:	movl %esi, 0x30(%eax)
0x0040fc0a:	addl %esi, $0x34<UINT8>
0x0040fc0d:	movl %eax, (%esi)
0x0040fc0f:	pushl %edi
0x0040fc10:	testl %eax, %eax
0x0040fc12:	jne 58
0x0040fc14:	movl %ebx, 0x41e1bc
0x0040fc1a:	pushl $0x8<UINT8>
0x0040fc1c:	pushl %eax
0x0040fc1d:	call GetProcessHeap@KERNEL32.dll
GetProcessHeap@KERNEL32.dll: API Node	
0x0040fc1f:	pushl %eax
0x0040fc20:	call HeapAlloc@KERNEL32.dll
0x0040fc26:	movl %edi, %eax
0x0040fc28:	xorl %eax, %eax
0x0040fc2a:	cmpl %edi, %eax
0x0040fc2c:	je 40
0x0040fc2e:	pushl %eax
0x0040fc2f:	pushl %edi
0x0040fc30:	pushl %esi
0x0040fc31:	movl (%edi), %eax
0x0040fc33:	movl 0x4(%edi), %eax
0x0040fc36:	call InterlockedCompareExchange@KERNEL32.dll
InterlockedCompareExchange@KERNEL32.dll: API Node	
0x0040fc3c:	testl %eax, %eax
0x0040fc3e:	je 12
0x0040fc40:	pushl %edi
0x0040fc41:	pushl $0x0<UINT8>
0x0040fc43:	call GetProcessHeap@KERNEL32.dll
0x0040fc45:	pushl %eax
0x0040fc46:	call HeapFree@KERNEL32.dll
0x0040fc4c:	movl %eax, (%esi)
0x0040fc4e:	movl 0x425464, %eax
0x0040fc53:	xorl %eax, %eax
0x0040fc55:	incl %eax
0x0040fc56:	popl %edi
0x0040fc57:	popl %esi
0x0040fc58:	popl %ebx
...
0x0040fc7c:	testl %eax, %eax
0x0040fc7e:	je 69
0x0040fc80:	movl %eax, 0x425464
0x0040fc85:	cmpl %eax, $0x1<UINT8>
0x0040fc88:	jne 0x0040fca1
0x0040fca1:	movl %edi, 0x41e194
0x0040fca7:	pushl %eax
0x0040fca8:	call InterlockedPopEntrySList@KERNEL32.dll
InterlockedPopEntrySList@KERNEL32.dll: API Node	
0x0040fcaa:	testl %eax, %eax
0x0040fcac:	jne 0x0040fd07
0x0040fcae:	pushl $0x40<UINT8>
0x0040fd07:	popl %edi
0x0040fd08:	popl %esi
0x0040fd09:	ret

0x0018fe48:	testb %dl, %dh
0x0018fe4a:	incl %ecx
0x0018fe4b:	addb (%eax), %al
0x0018fe4d:	addb (%eax), %al
0x0018fe4f:	addb %al, %bh
0x0018fe51:	stc
0x0018fe52:	cli
0x0018fe53:	sti
0x0018fe54:	cld
...
0x0040fcb0:	movl %eax, $0x1000<UINT32>
0x0040fcb5:	pushl %eax
0x0040fcb6:	pushl %eax
0x0040fcb7:	pushl $0x0<UINT8>
0x0040fcb9:	call VirtualAlloc@KERNEL32.dll
VirtualAlloc@KERNEL32.dll: API Node	
0x0040fcbf:	movl %esi, %eax
0x0040fcc1:	testl %esi, %esi
0x0040fcc3:	jne 0x0040fcc9
0x0040fcc9:	movl %eax, (%esi)
0x0040fccb:	pushl 0x425464
0x0040fcd1:	call InterlockedPopEntrySList@KERNEL32.dll
0x0040fcd3:	movl %edi, %eax
0x0040fcd5:	testl %edi, %edi
0x0040fcd7:	je 0x0040fceb
0x0040fceb:	leal %edi, 0xff0(%esi)
0x0040fcf1:	pushl %esi
0x0040fcf2:	pushl 0x425464
0x0040fcf8:	call InterlockedPushEntrySList@KERNEL32.dll
InterlockedPushEntrySList@KERNEL32.dll: API Node	
0x0040fcfe:	addl %esi, $0x10<UINT8>
0x0040fd01:	cmpl %esi, %edi
0x0040fd03:	jb 0x0040fcf1
0x0040fd05:	movl %eax, %esi
