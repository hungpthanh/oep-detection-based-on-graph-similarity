0x0047ab10:	pusha
0x0047ab11:	movl %esi, $0x453000<UINT32>
0x0047ab16:	leal %edi, -335872(%esi)
0x0047ab1c:	pushl %edi
0x0047ab1d:	orl %ebp, $0xffffffff<UINT8>
0x0047ab20:	jmp 0x0047ab32
0x0047ab32:	movl %ebx, (%esi)
0x0047ab34:	subl %esi, $0xfffffffc<UINT8>
0x0047ab37:	adcl %ebx, %ebx
0x0047ab39:	jb 0x0047ab28
0x0047ab28:	movb %al, (%esi)
0x0047ab2a:	incl %esi
0x0047ab2b:	movb (%edi), %al
0x0047ab2d:	incl %edi
0x0047ab2e:	addl %ebx, %ebx
0x0047ab30:	jne 0x0047ab39
0x0047ab3b:	movl %eax, $0x1<UINT32>
0x0047ab40:	addl %ebx, %ebx
0x0047ab42:	jne 0x0047ab4b
0x0047ab4b:	adcl %eax, %eax
0x0047ab4d:	addl %ebx, %ebx
0x0047ab4f:	jae 0x0047ab5c
0x0047ab51:	jne 0x0047ab7b
0x0047ab7b:	xorl %ecx, %ecx
0x0047ab7d:	subl %eax, $0x3<UINT8>
0x0047ab80:	jb 0x0047ab93
0x0047ab93:	addl %ebx, %ebx
0x0047ab95:	jne 0x0047ab9e
0x0047ab9e:	jb 0x0047ab6c
0x0047aba0:	incl %ecx
0x0047aba1:	addl %ebx, %ebx
0x0047aba3:	jne 0x0047abac
0x0047abac:	jb 0x0047ab6c
0x0047abae:	addl %ebx, %ebx
0x0047abb0:	jne 0x0047abb9
0x0047abb9:	adcl %ecx, %ecx
0x0047abbb:	addl %ebx, %ebx
0x0047abbd:	jae 0x0047abae
0x0047abbf:	jne 0x0047abca
0x0047abca:	addl %ecx, $0x2<UINT8>
0x0047abcd:	cmpl %ebp, $0xfffffb00<UINT32>
0x0047abd3:	adcl %ecx, $0x2<UINT8>
0x0047abd6:	leal %edx, (%edi,%ebp)
0x0047abd9:	cmpl %ebp, $0xfffffffc<UINT8>
0x0047abdc:	jbe 0x0047abec
0x0047abde:	movb %al, (%edx)
0x0047abe0:	incl %edx
0x0047abe1:	movb (%edi), %al
0x0047abe3:	incl %edi
0x0047abe4:	decl %ecx
0x0047abe5:	jne 0x0047abde
0x0047abe7:	jmp 0x0047ab2e
0x0047ab82:	shll %eax, $0x8<UINT8>
0x0047ab85:	movb %al, (%esi)
0x0047ab87:	incl %esi
0x0047ab88:	xorl %eax, $0xffffffff<UINT8>
0x0047ab8b:	je 0x0047ac02
0x0047ab8d:	sarl %eax
0x0047ab8f:	movl %ebp, %eax
0x0047ab91:	jmp 0x0047ab9e
0x0047abec:	movl %eax, (%edx)
0x0047abee:	addl %edx, $0x4<UINT8>
0x0047abf1:	movl (%edi), %eax
0x0047abf3:	addl %edi, $0x4<UINT8>
0x0047abf6:	subl %ecx, $0x4<UINT8>
0x0047abf9:	ja 0x0047abec
0x0047abfb:	addl %edi, %ecx
0x0047abfd:	jmp 0x0047ab2e
0x0047ab6c:	addl %ebx, %ebx
0x0047ab6e:	jne 0x0047ab77
0x0047ab77:	adcl %ecx, %ecx
0x0047ab79:	jmp 0x0047abcd
0x0047ab53:	movl %ebx, (%esi)
0x0047ab55:	subl %esi, $0xfffffffc<UINT8>
0x0047ab58:	adcl %ebx, %ebx
0x0047ab5a:	jb 0x0047ab7b
0x0047ab5c:	decl %eax
0x0047ab5d:	addl %ebx, %ebx
0x0047ab5f:	jne 0x0047ab68
0x0047ab68:	adcl %eax, %eax
0x0047ab6a:	jmp 0x0047ab40
0x0047ab70:	movl %ebx, (%esi)
0x0047ab72:	subl %esi, $0xfffffffc<UINT8>
0x0047ab75:	adcl %ebx, %ebx
0x0047abb2:	movl %ebx, (%esi)
0x0047abb4:	subl %esi, $0xfffffffc<UINT8>
0x0047abb7:	adcl %ebx, %ebx
0x0047ab97:	movl %ebx, (%esi)
0x0047ab99:	subl %esi, $0xfffffffc<UINT8>
0x0047ab9c:	adcl %ebx, %ebx
0x0047ab44:	movl %ebx, (%esi)
0x0047ab46:	subl %esi, $0xfffffffc<UINT8>
0x0047ab49:	adcl %ebx, %ebx
0x0047abc1:	movl %ebx, (%esi)
0x0047abc3:	subl %esi, $0xfffffffc<UINT8>
0x0047abc6:	adcl %ebx, %ebx
0x0047abc8:	jae 0x0047abae
0x0047aba5:	movl %ebx, (%esi)
0x0047aba7:	subl %esi, $0xfffffffc<UINT8>
0x0047abaa:	adcl %ebx, %ebx
0x0047ab61:	movl %ebx, (%esi)
0x0047ab63:	subl %esi, $0xfffffffc<UINT8>
0x0047ab66:	adcl %ebx, %ebx
0x0047ac02:	popl %esi
0x0047ac03:	movl %edi, %esi
0x0047ac05:	movl %ecx, $0x1e67<UINT32>
0x0047ac0a:	movb %al, (%edi)
0x0047ac0c:	incl %edi
0x0047ac0d:	subb %al, $0xffffffe8<UINT8>
0x0047ac0f:	cmpb %al, $0x1<UINT8>
0x0047ac11:	ja 0x0047ac0a
0x0047ac13:	cmpb (%edi), $0x11<UINT8>
0x0047ac16:	jne 0x0047ac0a
0x0047ac18:	movl %eax, (%edi)
0x0047ac1a:	movb %bl, 0x4(%edi)
0x0047ac1d:	shrw %ax, $0x8<UINT8>
0x0047ac21:	roll %eax, $0x10<UINT8>
0x0047ac24:	xchgb %ah, %al
0x0047ac26:	subl %eax, %edi
0x0047ac28:	subb %bl, $0xffffffe8<UINT8>
0x0047ac2b:	addl %eax, %esi
0x0047ac2d:	movl (%edi), %eax
0x0047ac2f:	addl %edi, $0x5<UINT8>
0x0047ac32:	movb %al, %bl
0x0047ac34:	loop 0x0047ac0f
0x0047ac36:	leal %edi, 0x77000(%esi)
0x0047ac3c:	movl %eax, (%edi)
0x0047ac3e:	orl %eax, %eax
0x0047ac40:	je 0x0047ac87
0x0047ac42:	movl %ebx, 0x4(%edi)
0x0047ac45:	leal %eax, 0x7dfdc(%eax,%esi)
0x0047ac4c:	addl %ebx, %esi
0x0047ac4e:	pushl %eax
0x0047ac4f:	addl %edi, $0x8<UINT8>
0x0047ac52:	call LoadLibraryA@KERNEL32.DLL
LoadLibraryA@kernel32.dll: API Node	
0x0047ac58:	xchgl %ebp, %eax
0x0047ac59:	movb %al, (%edi)
0x0047ac5b:	incl %edi
0x0047ac5c:	orb %al, %al
0x0047ac5e:	je 0x0047ac3c
0x0047ac60:	movl %ecx, %edi
0x0047ac62:	jns 0x0047ac6b
0x0047ac6b:	pushl %edi
0x0047ac6c:	decl %eax
0x0047ac6d:	repn scasb %al, %es:(%edi)
0x0047ac6f:	pushl %ebp
0x0047ac70:	call GetProcAddress@KERNEL32.DLL
GetProcAddress@kernel32.dll: API Node	
0x0047ac76:	orl %eax, %eax
0x0047ac78:	je 7
0x0047ac7a:	movl (%ebx), %eax
0x0047ac7c:	addl %ebx, $0x4<UINT8>
0x0047ac7f:	jmp 0x0047ac59
GetProcAddress@KERNEL32.DLL: API Node	
LoadLibraryA@KERNEL32.DLL: API Node	
0x0047ac64:	movzwl %eax, (%edi)
0x0047ac67:	incl %edi
0x0047ac68:	pushl %eax
0x0047ac69:	incl %edi
0x0047ac6a:	movl %ecx, $0xaef24857<UINT32>
0x0047ac87:	movl %ebp, 0x7e13c(%esi)
0x0047ac8d:	leal %edi, -4096(%esi)
0x0047ac93:	movl %ebx, $0x1000<UINT32>
0x0047ac98:	pushl %eax
0x0047ac99:	pushl %esp
0x0047ac9a:	pushl $0x4<UINT8>
0x0047ac9c:	pushl %ebx
0x0047ac9d:	pushl %edi
0x0047ac9e:	call VirtualProtect@kernel32.dll
VirtualProtect@kernel32.dll: API Node	
0x0047aca0:	leal %eax, 0x217(%edi)
0x0047aca6:	andb (%eax), $0x7f<UINT8>
0x0047aca9:	andb 0x28(%eax), $0x7f<UINT8>
0x0047acad:	popl %eax
0x0047acae:	pushl %eax
0x0047acaf:	pushl %esp
0x0047acb0:	pushl %eax
0x0047acb1:	pushl %ebx
0x0047acb2:	pushl %edi
0x0047acb3:	call VirtualProtect@kernel32.dll
0x0047acb5:	popl %eax
0x0047acb6:	popa
0x0047acb7:	leal %eax, -128(%esp)
0x0047acbb:	pushl $0x0<UINT8>
0x0047acbd:	cmpl %esp, %eax
0x0047acbf:	jne 0x0047acbb
0x0047acc1:	subl %esp, $0xffffff80<UINT8>
0x0047acc4:	jmp 0x004149ec
...
0x004194bf:	je 10
0x004194c1:	pushl 0x8(%ebp)
0x004194c4:	call 0x00415187
0x00415187:	movl %edi, %edi
0x00415189:	pushl %ebp
0x0041518a:	movl %ebp, %esp
0x0041518c:	call 0x00415127
0x00415127:	movl %eax, $0x41dfb4<UINT32>
0x0041512c:	movl 0x460d20, %eax
0x00415131:	movl 0x460d24, $0x41d69b<UINT32>
0x0041513b:	movl 0x460d28, $0x41d64f<UINT32>
0x00415145:	movl 0x460d2c, $0x41d688<UINT32>
0x0041514f:	movl 0x460d30, $0x41d5f1<UINT32>
0x00415159:	movl 0x460d34, %eax
0x0041515e:	movl 0x460d38, $0x41df2c<UINT32>
0x00415168:	movl 0x460d3c, $0x41d60d<UINT32>
0x00415172:	movl 0x460d40, $0x41d56f<UINT32>
0x0041517c:	movl 0x460d44, $0x41d4fc<UINT32>
0x00415186:	ret

0x00415191:	call 0x0041e061
0x0041e061:	pushl $0x451524<UINT32>
0x0041e066:	call GetModuleHandleA@KERNEL32.DLL
GetModuleHandleA@KERNEL32.DLL: API Node	
0x0041e06c:	testl %eax, %eax
0x0041e06e:	je 21
0x0041e070:	pushl $0x451508<UINT32>
0x0041e075:	pushl %eax
0x0041e076:	call GetProcAddress@KERNEL32.DLL
0x0041e07c:	testl %eax, %eax
0x0041e07e:	je 5
0x0041e080:	pushl $0x0<UINT8>
0x0041e082:	call IsProcessorFeaturePresent@KERNEL32
IsProcessorFeaturePresent@KERNEL32: API Node	
0x0041e084:	ret

0x00415196:	cmpl 0x8(%ebp), $0x0<UINT8>
0x0041519a:	movl 0x46a370, %eax
0x0041519f:	je 5
0x004151a1:	call 0x0041dff8
0x0041dff8:	movl %edi, %edi
0x0041dffa:	pushl %esi
0x0041dffb:	pushl $0x30000<UINT32>
0x0041e000:	pushl $0x10000<UINT32>
0x0041e005:	xorl %esi, %esi
0x0041e007:	pushl %esi
0x0041e008:	call 0x00421e18
0x00421e18:	movl %edi, %edi
0x00421e1a:	pushl %ebp
0x00421e1b:	movl %ebp, %esp
0x00421e1d:	movl %eax, 0x10(%ebp)
0x00421e20:	movl %ecx, 0xc(%ebp)
0x00421e23:	andl %eax, $0xfff7ffff<UINT32>
0x00421e28:	andl %ecx, %eax
0x00421e2a:	pushl %esi
0x00421e2b:	testl %ecx, $0xfcf0fce0<UINT32>
0x00421e31:	je 0x00421e64
0x00421e64:	movl %esi, 0x8(%ebp)
0x00421e67:	pushl %eax
0x00421e68:	pushl 0xc(%ebp)
0x00421e6b:	testl %esi, %esi
0x00421e6d:	je 0x00421e78
0x00421e78:	call 0x00424ea5
0x00424ea5:	movl %edi, %edi
0x00424ea7:	pushl %ebp
0x00424ea8:	movl %ebp, %esp
0x00424eaa:	subl %esp, $0x14<UINT8>
0x00424ead:	pushl %ebx
0x00424eae:	pushl %esi
0x00424eaf:	pushl %edi
0x00424eb0:	fwait
0x00424eb1:	fnstcw -8(%ebp)
0x00424eb4:	movl %ebx, -8(%ebp)
0x00424eb7:	xorl %edx, %edx
0x00424eb9:	testb %bl, $0x1<UINT8>
0x00424ebc:	je 0x00424ec1
0x00424ec1:	testb %bl, $0x4<UINT8>
0x00424ec4:	je 3
0x00424ec6:	orl %edx, $0x8<UINT8>
0x00424ec9:	testb %bl, $0x8<UINT8>
0x00424ecc:	je 3
0x00424ece:	orl %edx, $0x4<UINT8>
0x00424ed1:	testb %bl, $0x10<UINT8>
0x00424ed4:	je 0x00424ed9
0x00424ed9:	testb %bl, $0x20<UINT8>
0x00424edc:	je 3
0x00424ede:	orl %edx, $0x1<UINT8>
0x00424ee1:	testb %bl, $0x2<UINT8>
0x00424ee4:	je 0x00424eec
0x00424eec:	movzwl %ecx, %bx
0x00424eef:	movl %eax, %ecx
0x00424ef1:	movl %esi, $0xc00<UINT32>
0x00424ef6:	andl %eax, %esi
0x00424ef8:	movl %edi, $0x300<UINT32>
0x00424efd:	je 36
0x00424eff:	cmpl %eax, $0x400<UINT32>
0x00424f04:	je 23
0x00424f06:	cmpl %eax, $0x800<UINT32>
0x00424f0b:	je 8
0x00424f0d:	cmpl %eax, %esi
0x00424f0f:	jne 18
0x00424f11:	orl %edx, %edi
0x00424f13:	jmp 0x00424f23
0x00424f23:	andl %ecx, %edi
0x00424f25:	je 16
0x00424f27:	cmpl %ecx, $0x200<UINT32>
0x00424f2d:	jne 14
0x00424f2f:	orl %edx, $0x10000<UINT32>
0x00424f35:	jmp 0x00424f3d
0x00424f3d:	testl %ebx, $0x1000<UINT32>
0x00424f43:	je 6
0x00424f45:	orl %edx, $0x40000<UINT32>
0x00424f4b:	movl %edi, 0xc(%ebp)
0x00424f4e:	movl %ecx, 0x8(%ebp)
0x00424f51:	movl %eax, %edi
0x00424f53:	notl %eax
0x00424f55:	andl %eax, %edx
0x00424f57:	andl %ecx, %edi
0x00424f59:	orl %eax, %ecx
0x00424f5b:	movl 0xc(%ebp), %eax
0x00424f5e:	cmpl %eax, %edx
0x00424f60:	je 0x00425014
0x00425014:	xorl %esi, %esi
0x00425016:	cmpl 0x46c5b8, %esi
0x0042501c:	je 0x004251af
0x004251af:	popl %edi
0x004251b0:	popl %esi
0x004251b1:	popl %ebx
0x004251b2:	leave
...
0x00421e7d:	popl %ecx
0x00421e7e:	popl %ecx
0x00421e7f:	xorl %eax, %eax
0x00421e81:	popl %esi
0x00421e82:	popl %ebp
0x00421e83:	ret

0x0041e00d:	addl %esp, $0xc<UINT8>
0x0041e010:	testl %eax, %eax
0x0041e012:	je 0x0041e021
0x0041e021:	popl %esi
0x0041e022:	ret
...
0x004115fd:	leal %eax, -808(%ebp)
0x00411603:	movl -728(%ebp), %eax
0x00411609:	leal %eax, -720(%ebp)
0x0041160f:	addl %esp, $0xc<UINT8>
0x00411612:	movl -724(%ebp), %eax
0x00411618:	movl -544(%ebp), %eax
0x0041161e:	movl -548(%ebp), %ecx
0x00411624:	movl -552(%ebp), %edx
0x0041162a:	movl -556(%ebp), %ebx
0x00411630:	movl -560(%ebp), %esi
0x00411636:	movl -564(%ebp), %edi
0x0041163c:	movw -520(%ebp), %ss
0x00411643:	movw -532(%ebp), %cs
0x0041164a:	movw -568(%ebp), %ds
0x00411651:	movw -572(%ebp), %es
0x00411658:	movw -576(%ebp), %fs
0x0041165f:	movw -580(%ebp), %gs
0x00411666:	pushfl
0x00411667:	popl -528(%ebp)
0x0041166d:	movl %eax, 0x4(%ebp)
0x00411670:	leal %ecx, 0x4(%ebp)
0x00411673:	movl -720(%ebp), $0x10001<UINT32>
0x0041167d:	movl -536(%ebp), %eax
0x00411683:	movl -524(%ebp), %ecx
0x00411689:	movl %ecx, -4(%ecx)
0x0041168c:	movl -540(%ebp), %ecx
0x00411692:	movl -808(%ebp), $0xc0000417<UINT32>
0x0041169c:	movl -804(%ebp), $0x1<UINT32>
0x004116a6:	movl -796(%ebp), %eax
0x004116ac:	call IsDebuggerPresent@KERNEL32.DLL
IsDebuggerPresent@KERNEL32.DLL: API Node	
0x004116b2:	pushl $0x0<UINT8>
0x004116b4:	movl %ebx, %eax
0x004116b6:	call SetUnhandledExceptionFilter@KERNEL32.DLL
0x004116bc:	leal %eax, -728(%ebp)
0x004116c2:	pushl %eax
0x004116c3:	call UnhandledExceptionFilter@KERNEL32.DLL
UnhandledExceptionFilter@KERNEL32.DLL: API Node	
0x004116c9:	testl %eax, %eax
0x004116cb:	jne 0x004116d9
0x004116d9:	pushl $0xc0000417<UINT32>
0x004116de:	call GetCurrentProcess@KERNEL32.DLL
0x004116e4:	pushl %eax
0x004116e5:	call TerminateProcess@KERNEL32.DLL
TerminateProcess@KERNEL32.DLL: API Node	
0x004116eb:	movl %ecx, -4(%ebp)
