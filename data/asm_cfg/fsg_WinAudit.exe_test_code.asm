0x00816000:	movl %ebx, $0x4001d0<UINT32>
0x00816005:	movl %edi, $0x401000<UINT32>
0x0081600a:	movl %esi, $0x70f810<UINT32>
0x0081600f:	pushl %ebx
0x00816010:	call 0x0081601f
0x0081601f:	cld
0x00816020:	movb %dl, $0xffffff80<UINT8>
0x00816022:	movsb %es:(%edi), %ds:(%esi)
0x00816023:	pushl $0x2<UINT8>
0x00816025:	popl %ebx
0x00816026:	call 0x00816015
0x00816015:	addb %dl, %dl
0x00816017:	jne 0x0081601e
0x00816019:	movb %dl, (%esi)
0x0081601b:	incl %esi
0x0081601c:	adcb %dl, %dl
0x0081601e:	ret

0x00816029:	jae 0x00816022
0x0081602b:	xorl %ecx, %ecx
0x0081602d:	call 0x00816015
0x00816030:	jae 0x0081604a
0x00816032:	xorl %eax, %eax
0x00816034:	call 0x00816015
0x00816037:	jae 0x0081605a
0x00816039:	movb %bl, $0x2<UINT8>
0x0081603b:	incl %ecx
0x0081603c:	movb %al, $0x10<UINT8>
0x0081603e:	call 0x00816015
0x00816041:	adcb %al, %al
0x00816043:	jae 0x0081603e
0x00816045:	jne 0x00816086
0x00816047:	stosb %es:(%edi), %al
0x00816048:	jmp 0x00816026
0x00816086:	pushl %esi
0x00816087:	movl %esi, %edi
0x00816089:	subl %esi, %eax
0x0081608b:	rep movsb %es:(%edi), %ds:(%esi)
0x0081608d:	popl %esi
0x0081608e:	jmp 0x00816026
0x0081605a:	lodsb %al, %ds:(%esi)
0x0081605b:	shrl %eax
0x0081605d:	je 0x008160a0
0x0081605f:	adcl %ecx, %ecx
0x00816061:	jmp 0x0081607f
0x0081607f:	incl %ecx
0x00816080:	incl %ecx
0x00816081:	xchgl %ebp, %eax
0x00816082:	movl %eax, %ebp
0x00816084:	movb %bl, $0x1<UINT8>
0x0081604a:	call 0x00816092
0x00816092:	incl %ecx
0x00816093:	call 0x00816015
0x00816097:	adcl %ecx, %ecx
0x00816099:	call 0x00816015
0x0081609d:	jb 0x00816093
0x0081609f:	ret

0x0081604f:	subl %ecx, %ebx
0x00816051:	jne 0x00816063
0x00816053:	call 0x00816090
0x00816090:	xorl %ecx, %ecx
0x00816058:	jmp 0x00816082
0x00816063:	xchgl %ecx, %eax
0x00816064:	decl %eax
0x00816065:	shll %eax, $0x8<UINT8>
0x00816068:	lodsb %al, %ds:(%esi)
0x00816069:	call 0x00816090
0x0081606e:	cmpl %eax, $0x7d00<UINT32>
0x00816073:	jae 0x0081607f
0x00816075:	cmpb %ah, $0x5<UINT8>
0x00816078:	jae 0x00816080
0x0081607a:	cmpl %eax, $0x7f<UINT8>
0x0081607d:	ja 0x00816081
0x008160a0:	popl %edi
0x008160a1:	popl %ebx
0x008160a2:	movzwl %edi, (%ebx)
0x008160a5:	decl %edi
0x008160a6:	je 0x008160b0
0x008160a8:	decl %edi
0x008160a9:	je 0x008160be
0x008160ab:	shll %edi, $0xc<UINT8>
0x008160ae:	jmp 0x008160b7
0x008160b7:	incl %ebx
0x008160b8:	incl %ebx
0x008160b9:	jmp 0x0081600f
0x008160b0:	movl %edi, 0x2(%ebx)
0x008160b3:	pushl %edi
0x008160b4:	addl %ebx, $0x4<UINT8>
0x008160be:	popl %edi
0x008160bf:	movl %ebx, $0x816128<UINT32>
0x008160c4:	incl %edi
0x008160c5:	movl %esi, (%edi)
0x008160c7:	scasl %eax, %es:(%edi)
0x008160c8:	pushl %edi
0x008160c9:	call LoadLibraryA@KERNEL32.DLL
LoadLibraryA@kernel32.dll: API Node	
0x008160cb:	xchgl %ebp, %eax
0x008160cc:	xorl %eax, %eax
0x008160ce:	scasb %al, %es:(%edi)
0x008160cf:	jne 0x008160ce
0x008160d1:	decb (%edi)
0x008160d3:	je 0x008160c4
0x008160d5:	decb (%edi)
0x008160d7:	jne 0x008160df
0x008160df:	decb (%edi)
0x008160e1:	je 0x0051b411
0x008160e7:	pushl %edi
0x008160e8:	pushl %ebp
0x008160e9:	call GetProcAddress@KERNEL32.DLL
GetProcAddress@kernel32.dll: API Node	
0x008160ec:	orl (%esi), %eax
0x008160ee:	lodsl %eax, %ds:(%esi)
0x008160ef:	jne 0x008160cc
GetProcAddress@KERNEL32.DLL: API Node	
LoadLibraryA@KERNEL32.DLL: API Node	
0x008160d9:	incl %edi
0x008160da:	pushl (%edi)
0x008160dc:	scasl %eax, %es:(%edi)
0x008160dd:	jmp 0x008160e8
