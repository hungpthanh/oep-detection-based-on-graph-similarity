0x00430280:	pusha
0x00430281:	movl %esi, $0x41e000<UINT32>
0x00430286:	leal %edi, -118784(%esi)
0x0043028c:	pushl %edi
0x0043028d:	orl %ebp, $0xffffffff<UINT8>
0x00430290:	jmp 0x004302a2
0x004302a2:	movl %ebx, (%esi)
0x004302a4:	subl %esi, $0xfffffffc<UINT8>
0x004302a7:	adcl %ebx, %ebx
0x004302a9:	jb 0x00430298
0x00430298:	movb %al, (%esi)
0x0043029a:	incl %esi
0x0043029b:	movb (%edi), %al
0x0043029d:	incl %edi
0x0043029e:	addl %ebx, %ebx
0x004302a0:	jne 0x004302a9
0x004302ab:	movl %eax, $0x1<UINT32>
0x004302b0:	addl %ebx, %ebx
0x004302b2:	jne 0x004302bb
0x004302bb:	adcl %eax, %eax
0x004302bd:	addl %ebx, %ebx
0x004302bf:	jae 0x004302b0
0x004302c1:	jne 0x004302cc
0x004302cc:	xorl %ecx, %ecx
0x004302ce:	subl %eax, $0x3<UINT8>
0x004302d1:	jb 0x004302e0
0x004302e0:	addl %ebx, %ebx
0x004302e2:	jne 0x004302eb
0x004302eb:	adcl %ecx, %ecx
0x004302ed:	addl %ebx, %ebx
0x004302ef:	jne 0x004302f8
0x004302f8:	adcl %ecx, %ecx
0x004302fa:	jne 0x0043031c
0x0043031c:	cmpl %ebp, $0xfffff300<UINT32>
0x00430322:	adcl %ecx, $0x1<UINT8>
0x00430325:	leal %edx, (%edi,%ebp)
0x00430328:	cmpl %ebp, $0xfffffffc<UINT8>
0x0043032b:	jbe 0x0043033c
0x0043032d:	movb %al, (%edx)
0x0043032f:	incl %edx
0x00430330:	movb (%edi), %al
0x00430332:	incl %edi
0x00430333:	decl %ecx
0x00430334:	jne 0x0043032d
0x00430336:	jmp 0x0043029e
0x004302d3:	shll %eax, $0x8<UINT8>
0x004302d6:	movb %al, (%esi)
0x004302d8:	incl %esi
0x004302d9:	xorl %eax, $0xffffffff<UINT8>
0x004302dc:	je 0x00430352
0x004302de:	movl %ebp, %eax
0x0043033c:	movl %eax, (%edx)
0x0043033e:	addl %edx, $0x4<UINT8>
0x00430341:	movl (%edi), %eax
0x00430343:	addl %edi, $0x4<UINT8>
0x00430346:	subl %ecx, $0x4<UINT8>
0x00430349:	ja 0x0043033c
0x0043034b:	addl %edi, %ecx
0x0043034d:	jmp 0x0043029e
0x004302f1:	movl %ebx, (%esi)
0x004302f3:	subl %esi, $0xfffffffc<UINT8>
0x004302f6:	adcl %ebx, %ebx
0x004302c3:	movl %ebx, (%esi)
0x004302c5:	subl %esi, $0xfffffffc<UINT8>
0x004302c8:	adcl %ebx, %ebx
0x004302ca:	jae 0x004302b0
0x004302fc:	incl %ecx
0x004302fd:	addl %ebx, %ebx
0x004302ff:	jne 0x00430308
0x00430308:	adcl %ecx, %ecx
0x0043030a:	addl %ebx, %ebx
0x0043030c:	jae 0x004302fd
0x0043030e:	jne 0x00430319
0x00430310:	movl %ebx, (%esi)
0x00430312:	subl %esi, $0xfffffffc<UINT8>
0x00430315:	adcl %ebx, %ebx
0x00430317:	jae 0x004302fd
0x00430319:	addl %ecx, $0x2<UINT8>
0x004302b4:	movl %ebx, (%esi)
0x004302b6:	subl %esi, $0xfffffffc<UINT8>
0x004302b9:	adcl %ebx, %ebx
0x004302e4:	movl %ebx, (%esi)
0x004302e6:	subl %esi, $0xfffffffc<UINT8>
0x004302e9:	adcl %ebx, %ebx
0x00430301:	movl %ebx, (%esi)
0x00430303:	subl %esi, $0xfffffffc<UINT8>
0x00430306:	adcl %ebx, %ebx
0x00430352:	popl %esi
0x00430353:	movl %edi, %esi
0x00430355:	movl %ecx, $0xce4<UINT32>
0x0043035a:	movb %al, (%edi)
0x0043035c:	incl %edi
0x0043035d:	subb %al, $0xffffffe8<UINT8>
0x0043035f:	cmpb %al, $0x1<UINT8>
0x00430361:	ja 0x0043035a
0x00430363:	cmpb (%edi), $0x12<UINT8>
0x00430366:	jne 0x0043035a
0x00430368:	movl %eax, (%edi)
0x0043036a:	movb %bl, 0x4(%edi)
0x0043036d:	shrw %ax, $0x8<UINT8>
0x00430371:	roll %eax, $0x10<UINT8>
0x00430374:	xchgb %ah, %al
0x00430376:	subl %eax, %edi
0x00430378:	subb %bl, $0xffffffe8<UINT8>
0x0043037b:	addl %eax, %esi
0x0043037d:	movl (%edi), %eax
0x0043037f:	addl %edi, $0x5<UINT8>
0x00430382:	movb %al, %bl
0x00430384:	loop 0x0043035f
0x00430386:	leal %edi, 0x2e000(%esi)
0x0043038c:	movl %eax, (%edi)
0x0043038e:	orl %eax, %eax
0x00430390:	je 0x004303d7
0x00430392:	movl %ebx, 0x4(%edi)
0x00430395:	leal %eax, 0x30550(%eax,%esi)
0x0043039c:	addl %ebx, %esi
0x0043039e:	pushl %eax
0x0043039f:	addl %edi, $0x8<UINT8>
0x004303a2:	call LoadLibraryA@KERNEL32.DLL
LoadLibraryA@kernel32.dll: API Node	
0x004303a8:	xchgl %ebp, %eax
0x004303a9:	movb %al, (%edi)
0x004303ab:	incl %edi
0x004303ac:	orb %al, %al
0x004303ae:	je 0x0043038c
0x004303b0:	movl %ecx, %edi
0x004303b2:	jns 0x004303bb
0x004303bb:	pushl %edi
0x004303bc:	decl %eax
0x004303bd:	repn scasb %al, %es:(%edi)
0x004303bf:	pushl %ebp
0x004303c0:	call GetProcAddress@KERNEL32.DLL
GetProcAddress@kernel32.dll: API Node	
0x004303c6:	orl %eax, %eax
0x004303c8:	je 7
0x004303ca:	movl (%ebx), %eax
0x004303cc:	addl %ebx, $0x4<UINT8>
0x004303cf:	jmp 0x004303a9
GetProcAddress@KERNEL32.DLL: API Node	
LoadLibraryA@KERNEL32.DLL: API Node	
0x004303b4:	movzwl %eax, (%edi)
0x004303b7:	incl %edi
0x004303b8:	pushl %eax
0x004303b9:	incl %edi
0x004303ba:	movl %ecx, $0xaef24857<UINT32>
0x004303d7:	movl %ebp, 0x3063c(%esi)
0x004303dd:	leal %edi, -4096(%esi)
0x004303e3:	movl %ebx, $0x1000<UINT32>
0x004303e8:	pushl %eax
0x004303e9:	pushl %esp
0x004303ea:	pushl $0x4<UINT8>
0x004303ec:	pushl %ebx
0x004303ed:	pushl %edi
0x004303ee:	call VirtualProtect@kernel32.dll
VirtualProtect@kernel32.dll: API Node	
0x004303f0:	leal %eax, 0x207(%edi)
0x004303f6:	andb (%eax), $0x7f<UINT8>
0x004303f9:	andb 0x28(%eax), $0x7f<UINT8>
0x004303fd:	popl %eax
0x004303fe:	pushl %eax
0x004303ff:	pushl %esp
0x00430400:	pushl %eax
0x00430401:	pushl %ebx
0x00430402:	pushl %edi
0x00430403:	call VirtualProtect@kernel32.dll
0x00430405:	popl %eax
0x00430406:	popa
0x00430407:	leal %eax, -128(%esp)
0x0043040b:	pushl $0x0<UINT8>
0x0043040d:	cmpl %esp, %eax
0x0043040f:	jne 0x0043040b
0x00430411:	subl %esp, $0xffffff80<UINT8>
0x00430414:	jmp 0x00409955
