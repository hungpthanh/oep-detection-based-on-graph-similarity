0x0044fd10:	pusha
0x0044fd11:	movl %esi, $0x431000<UINT32>
0x0044fd16:	leal %edi, -196608(%esi)
0x0044fd1c:	pushl %edi
0x0044fd1d:	orl %ebp, $0xffffffff<UINT8>
0x0044fd20:	jmp 0x0044fd32
0x0044fd32:	movl %ebx, (%esi)
0x0044fd34:	subl %esi, $0xfffffffc<UINT8>
0x0044fd37:	adcl %ebx, %ebx
0x0044fd39:	jb 0x0044fd28
0x0044fd28:	movb %al, (%esi)
0x0044fd2a:	incl %esi
0x0044fd2b:	movb (%edi), %al
0x0044fd2d:	incl %edi
0x0044fd2e:	addl %ebx, %ebx
0x0044fd30:	jne 0x0044fd39
0x0044fd3b:	movl %eax, $0x1<UINT32>
0x0044fd40:	addl %ebx, %ebx
0x0044fd42:	jne 0x0044fd4b
0x0044fd4b:	adcl %eax, %eax
0x0044fd4d:	addl %ebx, %ebx
0x0044fd4f:	jae 0x0044fd5c
0x0044fd51:	jne 0x0044fd7b
0x0044fd7b:	xorl %ecx, %ecx
0x0044fd7d:	subl %eax, $0x3<UINT8>
0x0044fd80:	jb 0x0044fd93
0x0044fd93:	addl %ebx, %ebx
0x0044fd95:	jne 0x0044fd9e
0x0044fd9e:	jb 0x0044fd6c
0x0044fda0:	incl %ecx
0x0044fda1:	addl %ebx, %ebx
0x0044fda3:	jne 0x0044fdac
0x0044fdac:	jb 0x0044fd6c
0x0044fdae:	addl %ebx, %ebx
0x0044fdb0:	jne 0x0044fdb9
0x0044fdb9:	adcl %ecx, %ecx
0x0044fdbb:	addl %ebx, %ebx
0x0044fdbd:	jae 0x0044fdae
0x0044fdbf:	jne 0x0044fdca
0x0044fdca:	addl %ecx, $0x2<UINT8>
0x0044fdcd:	cmpl %ebp, $0xfffffb00<UINT32>
0x0044fdd3:	adcl %ecx, $0x2<UINT8>
0x0044fdd6:	leal %edx, (%edi,%ebp)
0x0044fdd9:	cmpl %ebp, $0xfffffffc<UINT8>
0x0044fddc:	jbe 0x0044fdec
0x0044fdde:	movb %al, (%edx)
0x0044fde0:	incl %edx
0x0044fde1:	movb (%edi), %al
0x0044fde3:	incl %edi
0x0044fde4:	decl %ecx
0x0044fde5:	jne 0x0044fdde
0x0044fde7:	jmp 0x0044fd2e
0x0044fd6c:	addl %ebx, %ebx
0x0044fd6e:	jne 0x0044fd77
0x0044fd77:	adcl %ecx, %ecx
0x0044fd79:	jmp 0x0044fdcd
0x0044fd82:	shll %eax, $0x8<UINT8>
0x0044fd85:	movb %al, (%esi)
0x0044fd87:	incl %esi
0x0044fd88:	xorl %eax, $0xffffffff<UINT8>
0x0044fd8b:	je 0x0044fe02
0x0044fd8d:	sarl %eax
0x0044fd8f:	movl %ebp, %eax
0x0044fd91:	jmp 0x0044fd9e
0x0044fdec:	movl %eax, (%edx)
0x0044fdee:	addl %edx, $0x4<UINT8>
0x0044fdf1:	movl (%edi), %eax
0x0044fdf3:	addl %edi, $0x4<UINT8>
0x0044fdf6:	subl %ecx, $0x4<UINT8>
0x0044fdf9:	ja 0x0044fdec
0x0044fdfb:	addl %edi, %ecx
0x0044fdfd:	jmp 0x0044fd2e
0x0044fd53:	movl %ebx, (%esi)
0x0044fd55:	subl %esi, $0xfffffffc<UINT8>
0x0044fd58:	adcl %ebx, %ebx
0x0044fd5a:	jb 0x0044fd7b
0x0044fd70:	movl %ebx, (%esi)
0x0044fd72:	subl %esi, $0xfffffffc<UINT8>
0x0044fd75:	adcl %ebx, %ebx
0x0044fd5c:	decl %eax
0x0044fd5d:	addl %ebx, %ebx
0x0044fd5f:	jne 0x0044fd68
0x0044fd68:	adcl %eax, %eax
0x0044fd6a:	jmp 0x0044fd40
0x0044fd44:	movl %ebx, (%esi)
0x0044fd46:	subl %esi, $0xfffffffc<UINT8>
0x0044fd49:	adcl %ebx, %ebx
0x0044fd97:	movl %ebx, (%esi)
0x0044fd99:	subl %esi, $0xfffffffc<UINT8>
0x0044fd9c:	adcl %ebx, %ebx
0x0044fdb2:	movl %ebx, (%esi)
0x0044fdb4:	subl %esi, $0xfffffffc<UINT8>
0x0044fdb7:	adcl %ebx, %ebx
0x0044fd61:	movl %ebx, (%esi)
0x0044fd63:	subl %esi, $0xfffffffc<UINT8>
0x0044fd66:	adcl %ebx, %ebx
0x0044fdc1:	movl %ebx, (%esi)
0x0044fdc3:	subl %esi, $0xfffffffc<UINT8>
0x0044fdc6:	adcl %ebx, %ebx
0x0044fdc8:	jae 0x0044fdae
0x0044fda5:	movl %ebx, (%esi)
0x0044fda7:	subl %esi, $0xfffffffc<UINT8>
0x0044fdaa:	adcl %ebx, %ebx
0x0044fe02:	popl %esi
0x0044fe03:	movl %edi, %esi
0x0044fe05:	movl %ecx, $0x1485<UINT32>
0x0044fe0a:	movb %al, (%edi)
0x0044fe0c:	incl %edi
0x0044fe0d:	subb %al, $0xffffffe8<UINT8>
0x0044fe0f:	cmpb %al, $0x1<UINT8>
0x0044fe11:	ja 0x0044fe0a
0x0044fe13:	cmpb (%edi), $0x16<UINT8>
0x0044fe16:	jne 0x0044fe0a
0x0044fe18:	movl %eax, (%edi)
0x0044fe1a:	movb %bl, 0x4(%edi)
0x0044fe1d:	shrw %ax, $0x8<UINT8>
0x0044fe21:	roll %eax, $0x10<UINT8>
0x0044fe24:	xchgb %ah, %al
0x0044fe26:	subl %eax, %edi
0x0044fe28:	subb %bl, $0xffffffe8<UINT8>
0x0044fe2b:	addl %eax, %esi
0x0044fe2d:	movl (%edi), %eax
0x0044fe2f:	addl %edi, $0x5<UINT8>
0x0044fe32:	movb %al, %bl
0x0044fe34:	loop 0x0044fe0f
0x0044fe36:	leal %edi, 0x4c000(%esi)
0x0044fe3c:	movl %eax, (%edi)
0x0044fe3e:	orl %eax, %eax
0x0044fe40:	je 0x0044fe87
0x0044fe42:	movl %ebx, 0x4(%edi)
0x0044fe45:	leal %eax, 0x50118(%eax,%esi)
0x0044fe4c:	addl %ebx, %esi
0x0044fe4e:	pushl %eax
0x0044fe4f:	addl %edi, $0x8<UINT8>
0x0044fe52:	call LoadLibraryA@KERNEL32.DLL
LoadLibraryA@kernel32.dll: API Node	
0x0044fe58:	xchgl %ebp, %eax
0x0044fe59:	movb %al, (%edi)
0x0044fe5b:	incl %edi
0x0044fe5c:	orb %al, %al
0x0044fe5e:	je 0x0044fe3c
0x0044fe60:	movl %ecx, %edi
0x0044fe62:	jns 0x0044fe6b
0x0044fe6b:	pushl %edi
0x0044fe6c:	decl %eax
0x0044fe6d:	repn scasb %al, %es:(%edi)
0x0044fe6f:	pushl %ebp
0x0044fe70:	call GetProcAddress@KERNEL32.DLL
GetProcAddress@kernel32.dll: API Node	
0x0044fe76:	orl %eax, %eax
0x0044fe78:	je 7
0x0044fe7a:	movl (%ebx), %eax
0x0044fe7c:	addl %ebx, $0x4<UINT8>
0x0044fe7f:	jmp 0x0044fe59
GetProcAddress@KERNEL32.DLL: API Node	
LoadLibraryA@KERNEL32.DLL: API Node	
0x0044fe64:	movzwl %eax, (%edi)
0x0044fe67:	incl %edi
0x0044fe68:	pushl %eax
0x0044fe69:	incl %edi
0x0044fe6a:	movl %ecx, $0xaef24857<UINT32>
0x0044fe87:	movl %ebp, 0x50264(%esi)
0x0044fe8d:	leal %edi, -4096(%esi)
0x0044fe93:	movl %ebx, $0x1000<UINT32>
0x0044fe98:	pushl %eax
0x0044fe99:	pushl %esp
0x0044fe9a:	pushl $0x4<UINT8>
0x0044fe9c:	pushl %ebx
0x0044fe9d:	pushl %edi
0x0044fe9e:	call VirtualProtect@kernel32.dll
VirtualProtect@kernel32.dll: API Node	
0x0044fea0:	leal %eax, 0x1ff(%edi)
0x0044fea6:	andb (%eax), $0x7f<UINT8>
0x0044fea9:	andb 0x28(%eax), $0x7f<UINT8>
0x0044fead:	popl %eax
0x0044feae:	pushl %eax
0x0044feaf:	pushl %esp
0x0044feb0:	pushl %eax
0x0044feb1:	pushl %ebx
0x0044feb2:	pushl %edi
0x0044feb3:	call VirtualProtect@kernel32.dll
0x0044feb5:	popl %eax
0x0044feb6:	popa
0x0044feb7:	leal %eax, -128(%esp)
0x0044febb:	pushl $0x0<UINT8>
0x0044febd:	cmpl %esp, %eax
0x0044febf:	jne 0x0044febb
0x0044fec1:	subl %esp, $0xffffff80<UINT8>
0x0044fec4:	jmp 0x004149d8
...
0x0041dc05:	incl %edx
0x0041dc06:	addl %eax, $0x28<UINT8>
0x0041dc09:	cmpl %edx, %esi
0x0041dc0b:	jb 0x0041dbf5
0x0041dc0f:	popl %edi
0x0041dc10:	popl %esi
0x0041dc11:	popl %ebx
0x0041dc12:	popl %ebp
...
0x0041b6f9:	je 10
0x0041b6fb:	pushl 0x8(%ebp)
0x0041b6fe:	call 0x00412d84
0x00412d84:	movl %edi, %edi
0x00412d86:	pushl %ebp
0x00412d87:	movl %ebp, %esp
0x00412d89:	call 0x00412d0f
0x00412d0f:	movl %eax, $0x41d8a0<UINT32>
0x00412d14:	movl 0x446038, %eax
0x00412d19:	movl 0x44603c, $0x41cf2a<UINT32>
0x00412d23:	movl 0x446040, $0x41cede<UINT32>
0x00412d2d:	movl 0x446044, $0x41cf17<UINT32>
0x00412d37:	movl 0x446048, $0x41ce80<UINT32>
0x00412d41:	movl 0x44604c, %eax
0x00412d46:	movl 0x446050, $0x41d818<UINT32>
0x00412d50:	movl 0x446054, $0x41ce9c<UINT32>
0x00412d5a:	movl 0x446058, $0x41cdfe<UINT32>
0x00412d64:	movl 0x44605c, $0x41cd8b<UINT32>
0x00412d6e:	ret

0x00412d8e:	call 0x0041d94d
0x0041d94d:	pushl $0x43fc5c<UINT32>
0x0041d952:	call GetModuleHandleA@KERNEL32.DLL
GetModuleHandleA@KERNEL32.DLL: API Node	
0x0041d958:	testl %eax, %eax
0x0041d95a:	je 21
0x0041d95c:	pushl $0x43fc40<UINT32>
0x0041d961:	pushl %eax
0x0041d962:	call GetProcAddress@KERNEL32.DLL
0x0041d968:	testl %eax, %eax
0x0041d96a:	je 5
0x0041d96c:	pushl $0x0<UINT8>
0x0041d96e:	call IsProcessorFeaturePresent@KERNEL32
IsProcessorFeaturePresent@KERNEL32: API Node	
0x0041d970:	ret

0x00412d93:	cmpl 0x8(%ebp), $0x0<UINT8>
0x00412d97:	movl 0x44791c, %eax
0x00412d9c:	je 5
0x00412d9e:	call 0x0041d8e4
0x0041d8e4:	movl %edi, %edi
0x0041d8e6:	pushl %esi
0x0041d8e7:	pushl $0x30000<UINT32>
0x0041d8ec:	pushl $0x10000<UINT32>
0x0041d8f1:	xorl %esi, %esi
0x0041d8f3:	pushl %esi
0x0041d8f4:	call 0x004314b8
0x004314b8:	movl %edi, %edi
0x004314ba:	pushl %ebp
0x004314bb:	movl %ebp, %esp
0x004314bd:	movl %eax, 0x10(%ebp)
0x004314c0:	movl %ecx, 0xc(%ebp)
0x004314c3:	andl %eax, $0xfff7ffff<UINT32>
0x004314c8:	andl %ecx, %eax
0x004314ca:	pushl %esi
0x004314cb:	testl %ecx, $0xfcf0fce0<UINT32>
0x004314d1:	je 0x00431504
0x00431504:	movl %esi, 0x8(%ebp)
0x00431507:	pushl %eax
0x00431508:	pushl 0xc(%ebp)
0x0043150b:	testl %esi, %esi
0x0043150d:	je 0x00431518
0x00431518:	call 0x00437ad3
0x00437ad3:	movl %edi, %edi
0x00437ad5:	pushl %ebp
0x00437ad6:	movl %ebp, %esp
0x00437ad8:	subl %esp, $0x14<UINT8>
0x00437adb:	pushl %ebx
0x00437adc:	pushl %esi
0x00437add:	pushl %edi
0x00437ade:	fwait
0x00437adf:	fnstcw -8(%ebp)
0x00437ae2:	movl %ebx, -8(%ebp)
0x00437ae5:	xorl %edx, %edx
0x00437ae7:	testb %bl, $0x1<UINT8>
0x00437aea:	je 0x00437aef
0x00437aef:	testb %bl, $0x4<UINT8>
0x00437af2:	je 3
0x00437af4:	orl %edx, $0x8<UINT8>
0x00437af7:	testb %bl, $0x8<UINT8>
0x00437afa:	je 3
0x00437afc:	orl %edx, $0x4<UINT8>
0x00437aff:	testb %bl, $0x10<UINT8>
0x00437b02:	je 0x00437b07
0x00437b07:	testb %bl, $0x20<UINT8>
0x00437b0a:	je 3
0x00437b0c:	orl %edx, $0x1<UINT8>
0x00437b0f:	testb %bl, $0x2<UINT8>
0x00437b12:	je 0x00437b1a
0x00437b1a:	movzwl %ecx, %bx
0x00437b1d:	movl %eax, %ecx
0x00437b1f:	movl %esi, $0xc00<UINT32>
0x00437b24:	andl %eax, %esi
0x00437b26:	movl %edi, $0x300<UINT32>
0x00437b2b:	je 36
0x00437b2d:	cmpl %eax, $0x400<UINT32>
0x00437b32:	je 23
0x00437b34:	cmpl %eax, $0x800<UINT32>
0x00437b39:	je 8
0x00437b3b:	cmpl %eax, %esi
0x00437b3d:	jne 18
0x00437b3f:	orl %edx, %edi
0x00437b41:	jmp 0x00437b51
0x00437b51:	andl %ecx, %edi
0x00437b53:	je 16
0x00437b55:	cmpl %ecx, $0x200<UINT32>
0x00437b5b:	jne 14
0x00437b5d:	orl %edx, $0x10000<UINT32>
0x00437b63:	jmp 0x00437b6b
0x00437b6b:	testl %ebx, $0x1000<UINT32>
0x00437b71:	je 6
0x00437b73:	orl %edx, $0x40000<UINT32>
0x00437b79:	movl %edi, 0xc(%ebp)
0x00437b7c:	movl %ecx, 0x8(%ebp)
0x00437b7f:	movl %eax, %edi
0x00437b81:	notl %eax
0x00437b83:	andl %eax, %edx
0x00437b85:	andl %ecx, %edi
0x00437b87:	orl %eax, %ecx
0x00437b89:	movl 0xc(%ebp), %eax
0x00437b8c:	cmpl %eax, %edx
0x00437b8e:	je 0x00437c42
0x00437c42:	xorl %esi, %esi
0x00437c44:	cmpl 0x449578, %esi
0x00437c4a:	je 0x00437ddd
0x00437ddd:	popl %edi
0x00437dde:	popl %esi
0x00437ddf:	popl %ebx
0x00437de0:	leave
...
0x0043151d:	popl %ecx
0x0043151e:	popl %ecx
0x0043151f:	xorl %eax, %eax
0x00431521:	popl %esi
0x00431522:	popl %ebp
0x00431523:	ret

0x0041d8f9:	addl %esp, $0xc<UINT8>
0x0041d8fc:	testl %eax, %eax
0x0041d8fe:	je 0x0041d90d
0x0041d90d:	popl %esi
0x0041d90e:	ret
