0x00423000:	movl %ebx, $0x4001d0<UINT32>
0x00423005:	movl %edi, $0x401000<UINT32>
0x0042300a:	movl %esi, $0x418ec9<UINT32>
0x0042300f:	pushl %ebx
0x00423010:	call 0x0042301f
0x0042301f:	cld
0x00423020:	movb %dl, $0xffffff80<UINT8>
0x00423022:	movsb %es:(%edi), %ds:(%esi)
0x00423023:	pushl $0x2<UINT8>
0x00423025:	popl %ebx
0x00423026:	call 0x00423015
0x00423015:	addb %dl, %dl
0x00423017:	jne 0x0042301e
0x00423019:	movb %dl, (%esi)
0x0042301b:	incl %esi
0x0042301c:	adcb %dl, %dl
0x0042301e:	ret

0x00423029:	jae 0x00423022
0x0042302b:	xorl %ecx, %ecx
0x0042302d:	call 0x00423015
0x00423030:	jae 0x0042304a
0x00423032:	xorl %eax, %eax
0x00423034:	call 0x00423015
0x00423037:	jae 0x0042305a
0x00423039:	movb %bl, $0x2<UINT8>
0x0042303b:	incl %ecx
0x0042303c:	movb %al, $0x10<UINT8>
0x0042303e:	call 0x00423015
0x00423041:	adcb %al, %al
0x00423043:	jae 0x0042303e
0x00423045:	jne 0x00423086
0x00423086:	pushl %esi
0x00423087:	movl %esi, %edi
0x00423089:	subl %esi, %eax
0x0042308b:	rep movsb %es:(%edi), %ds:(%esi)
0x0042308d:	popl %esi
0x0042308e:	jmp 0x00423026
0x00423047:	stosb %es:(%edi), %al
0x00423048:	jmp 0x00423026
0x0042305a:	lodsb %al, %ds:(%esi)
0x0042305b:	shrl %eax
0x0042305d:	je 0x004230a0
0x0042305f:	adcl %ecx, %ecx
0x00423061:	jmp 0x0042307f
0x0042307f:	incl %ecx
0x00423080:	incl %ecx
0x00423081:	xchgl %ebp, %eax
0x00423082:	movl %eax, %ebp
0x00423084:	movb %bl, $0x1<UINT8>
0x0042304a:	call 0x00423092
0x00423092:	incl %ecx
0x00423093:	call 0x00423015
0x00423097:	adcl %ecx, %ecx
0x00423099:	call 0x00423015
0x0042309d:	jb 0x00423093
0x0042309f:	ret

0x0042304f:	subl %ecx, %ebx
0x00423051:	jne 0x00423063
0x00423053:	call 0x00423090
0x00423090:	xorl %ecx, %ecx
0x00423058:	jmp 0x00423082
0x00423063:	xchgl %ecx, %eax
0x00423064:	decl %eax
0x00423065:	shll %eax, $0x8<UINT8>
0x00423068:	lodsb %al, %ds:(%esi)
0x00423069:	call 0x00423090
0x0042306e:	cmpl %eax, $0x7d00<UINT32>
0x00423073:	jae 0x0042307f
0x00423075:	cmpb %ah, $0x5<UINT8>
0x00423078:	jae 0x00423080
0x0042307a:	cmpl %eax, $0x7f<UINT8>
0x0042307d:	ja 0x00423081
0x004230a0:	popl %edi
0x004230a1:	popl %ebx
0x004230a2:	movzwl %edi, (%ebx)
0x004230a5:	decl %edi
0x004230a6:	je 0x004230b0
0x004230a8:	decl %edi
0x004230a9:	je 0x004230be
0x004230ab:	shll %edi, $0xc<UINT8>
0x004230ae:	jmp 0x004230b7
0x004230b7:	incl %ebx
0x004230b8:	incl %ebx
0x004230b9:	jmp 0x0042300f
0x004230b0:	movl %edi, 0x2(%ebx)
0x004230b3:	pushl %edi
0x004230b4:	addl %ebx, $0x4<UINT8>
0x004230be:	popl %edi
0x004230bf:	movl %ebx, $0x423128<UINT32>
0x004230c4:	incl %edi
0x004230c5:	movl %esi, (%edi)
0x004230c7:	scasl %eax, %es:(%edi)
0x004230c8:	pushl %edi
0x004230c9:	call LoadLibraryA@KERNEL32.dll
LoadLibraryA@kernel32.dll: API Node	
0x004230cb:	xchgl %ebp, %eax
0x004230cc:	xorl %eax, %eax
0x004230ce:	scasb %al, %es:(%edi)
0x004230cf:	jne 0x004230ce
0x004230d1:	decb (%edi)
0x004230d3:	je 0x004230c4
0x004230d5:	decb (%edi)
0x004230d7:	jne 0x004230df
0x004230d9:	incl %edi
0x004230da:	pushl (%edi)
0x004230dc:	scasl %eax, %es:(%edi)
0x004230dd:	jmp 0x004230e8
0x004230e8:	pushl %ebp
0x004230e9:	call GetProcAddress@KERNEL32.dll
GetProcAddress@kernel32.dll: API Node	
0x004230ec:	orl (%esi), %eax
0x004230ee:	lodsl %eax, %ds:(%esi)
0x004230ef:	jne 0x004230cc
0x004230df:	decb (%edi)
0x004230e1:	je 0x00403ba0
0x004230e7:	pushl %edi
GetProcAddress@KERNEL32.dll: API Node	
LoadLibraryA@KERNEL32.dll: API Node	
