...
0x004187f8:	addl %esp, $0xc<UINT8>
0x004187fb:	pushl %ebx
0x004187fc:	pushl %esi
0x004187fd:	pushl 0x14(%ebp)
0x00418800:	pushl 0x10(%ebp)
0x00418803:	pushl $0x1<UINT8>
0x00418805:	pushl 0x1c(%ebp)
0x00418808:	call MultiByteToWideChar@KERNEL32.dll
0x0041880e:	testl %eax, %eax
0x00418810:	je 16
0x00418812:	pushl 0x18(%ebp)
0x00418815:	pushl %eax
0x00418816:	pushl %esi
0x00418817:	pushl 0xc(%ebp)
0x0041881a:	call GetStringTypeW@KERNEL32.dll
GetStringTypeW@KERNEL32.dll: API Node	
0x00418820:	movl %edi, %eax
0x00418822:	pushl %esi
0x00418823:	call 0x00418733
0x00418733:	pushl %ebp
0x00418734:	movl %ebp, %esp
0x00418736:	movl %eax, 0x8(%ebp)
0x00418739:	testl %eax, %eax
0x0041873b:	je 18
0x0041873d:	subl %eax, $0x8<UINT8>
0x00418740:	cmpl (%eax), $0xdddd<UINT32>
0x00418746:	jne 0x0041874f
0x0041874f:	popl %ebp
0x00418750:	ret

0x00418828:	popl %ecx
0x00418829:	movl %eax, %edi
0x0041882b:	leal %esp, -16(%ebp)
0x0041882e:	popl %edi
0x0041882f:	popl %esi
0x00418830:	popl %ebx
0x00418831:	movl %ecx, -4(%ebp)
0x00418834:	xorl %ecx, %ebp
0x00418836:	call 0x0040aae0
0x0040aae0:	cmpl %ecx, 0x43c650
0x0040aae6:	jne 2
0x0040aae8:	rep ret
...
0x00418869:	addl %esp, $0x1c<UINT8>
0x0041886c:	cmpb -4(%ebp), $0x0<UINT8>
0x00418870:	je 7
0x00418872:	movl %ecx, -8(%ebp)
0x00418875:	andl 0x70(%ecx), $0xfffffffd<UINT8>
0x00418879:	leave
0x0041887a:	ret

0x0040ccfd:	pushl %ebx
0x0040ccfe:	pushl 0x4(%esi)
0x0040cd01:	leal %eax, -516(%ebp)
0x0040cd07:	pushl %edi
0x0040cd08:	pushl %eax
0x0040cd09:	pushl %edi
0x0040cd0a:	leal %eax, -260(%ebp)
0x0040cd10:	pushl %eax
0x0040cd11:	pushl %edi
0x0040cd12:	pushl 0x21c(%esi)
0x0040cd18:	pushl %ebx
0x0040cd19:	call 0x004186ef
0x004186ef:	pushl %ebp
0x004186f0:	movl %ebp, %esp
0x004186f2:	subl %esp, $0x10<UINT8>
0x004186f5:	pushl 0x8(%ebp)
0x004186f8:	leal %ecx, -16(%ebp)
0x004186fb:	call 0x0040a520
0x00418700:	pushl 0x28(%ebp)
0x00418703:	leal %eax, -16(%ebp)
0x00418706:	pushl 0x24(%ebp)
0x00418709:	pushl 0x20(%ebp)
0x0041870c:	pushl 0x1c(%ebp)
0x0041870f:	pushl 0x18(%ebp)
0x00418712:	pushl 0x14(%ebp)
0x00418715:	pushl 0x10(%ebp)
0x00418718:	pushl 0xc(%ebp)
0x0041871b:	pushl %eax
0x0041871c:	call 0x004184d2
0x004184d2:	pushl %ebp
0x004184d3:	movl %ebp, %esp
0x004184d5:	pushl %ecx
0x004184d6:	pushl %ecx
0x004184d7:	movl %eax, 0x43c650
0x004184dc:	xorl %eax, %ebp
0x004184de:	movl -4(%ebp), %eax
0x004184e1:	pushl %ebx
0x004184e2:	pushl %esi
0x004184e3:	movl %esi, 0x18(%ebp)
0x004184e6:	pushl %edi
0x004184e7:	testl %esi, %esi
0x004184e9:	jle 33
0x004184eb:	movl %eax, 0x14(%ebp)
0x004184ee:	movl %ecx, %esi
0x004184f0:	decl %ecx
0x004184f1:	cmpb (%eax), $0x0<UINT8>
0x004184f4:	je 8
0x004184f6:	incl %eax
0x004184f7:	testl %ecx, %ecx
0x004184f9:	jne 0x004184f0
0x004184fb:	orl %ecx, $0xffffffff<UINT8>
0x004184fe:	movl %eax, %esi
0x00418500:	subl %eax, %ecx
0x00418502:	decl %eax
0x00418503:	cmpl %eax, %esi
0x00418505:	leal %esi, 0x1(%eax)
0x00418508:	jl 2
0x0041850a:	movl %esi, %eax
0x0041850c:	movl %ecx, 0x24(%ebp)
0x0041850f:	xorl %edi, %edi
0x00418511:	testl %ecx, %ecx
0x00418513:	jne 0x00418522
0x00418522:	xorl %eax, %eax
0x00418524:	cmpl 0x28(%ebp), %eax
0x00418527:	pushl $0x0<UINT8>
0x00418529:	setne %al
0x0041852c:	pushl $0x0<UINT8>
0x0041852e:	pushl %esi
0x0041852f:	pushl 0x14(%ebp)
0x00418532:	leal %eax, 0x1(,%eax,8)
0x00418539:	pushl %eax
0x0041853a:	pushl %ecx
0x0041853b:	call MultiByteToWideChar@KERNEL32.dll
0x00418541:	movl %ecx, %eax
0x00418543:	movl -8(%ebp), %ecx
0x00418546:	testl %ecx, %ecx
0x00418548:	jne 0x00418551
0x00418551:	jle 75
0x00418553:	pushl $0xffffffe0<UINT8>
0x00418555:	xorl %edx, %edx
0x00418557:	popl %eax
0x00418558:	divl %eax, %ecx
0x0041855a:	cmpl %eax, $0x2<UINT8>
0x0041855d:	jb 63
0x0041855f:	leal %ecx, 0x8(,%ecx,2)
0x00418566:	cmpl %ecx, $0x400<UINT32>
0x0041856c:	ja 21
0x0041856e:	movl %eax, %ecx
0x00418570:	call 0x00428d20
0x00418575:	movl %ebx, %esp
0x00418577:	testl %ebx, %ebx
0x00418579:	je 30
0x0041857b:	movl (%ebx), $0xcccc<UINT32>
0x00418581:	jmp 0x00418596
0x00418596:	addl %ebx, $0x8<UINT8>
0x00418599:	movl %ecx, -8(%ebp)
0x0041859c:	jmp 0x004185a0
0x004185a0:	testl %ebx, %ebx
0x004185a2:	je -90
0x004185a4:	pushl %ecx
0x004185a5:	pushl %ebx
0x004185a6:	pushl %esi
0x004185a7:	pushl 0x14(%ebp)
0x004185aa:	pushl $0x1<UINT8>
0x004185ac:	pushl 0x24(%ebp)
0x004185af:	call MultiByteToWideChar@KERNEL32.dll
0x004185b5:	testl %eax, %eax
0x004185b7:	je 227
0x004185bd:	movl %esi, -8(%ebp)
0x004185c0:	pushl $0x0<UINT8>
0x004185c2:	pushl $0x0<UINT8>
0x004185c4:	pushl %esi
0x004185c5:	pushl %ebx
0x004185c6:	pushl 0x10(%ebp)
0x004185c9:	pushl 0xc(%ebp)
0x004185cc:	call 0x0041d56e
0x0041d56e:	pushl %ebp
0x0041d56f:	movl %ebp, %esp
0x0041d571:	movl %eax, 0x43f02c
0x0041d576:	xorl %eax, 0x43c650
0x0041d57c:	je 27
0x0041d57e:	xorl %ecx, %ecx
0x0041d580:	pushl %ecx
0x0041d581:	pushl %ecx
0x0041d582:	pushl %ecx
0x0041d583:	pushl 0x1c(%ebp)
0x0041d586:	pushl 0x18(%ebp)
0x0041d589:	pushl 0x14(%ebp)
0x0041d58c:	pushl 0x10(%ebp)
0x0041d58f:	pushl 0xc(%ebp)
0x0041d592:	pushl 0x8(%ebp)
0x0041d595:	call LCMapStringEx@kernel32.dll
LCMapStringEx@kernel32.dll: API Node	
0x0041d597:	popl %ebp
0x0041d598:	ret

0x00000100:	addb (%eax), %al
0x00000102:	addb (%eax), %al
0x00000104:	addb (%eax), %al
0x00000106:	addb (%eax), %al
0x00000108:	addb (%eax), %al
0x0000010a:	addb (%eax), %al
0x0000010c:	addb (%eax), %al
0x0000010e:	addb (%eax), %al
0x00000110:	addb (%eax), %al
0x00000112:	addb (%eax), %al
0x00000114:	addb (%eax), %al
0x00000116:	addb (%eax), %al
0x00000118:	addb (%eax), %al
0x0000011a:	addb (%eax), %al
0x0000011c:	addb (%eax), %al
0x0000011e:	addb (%eax), %al
0x00000120:	addb (%eax), %al
0x00000122:	addb (%eax), %al
0x00000124:	addb (%eax), %al
0x00000126:	addb (%eax), %al
0x00000128:	addb (%eax), %al
0x0000012a:	addb (%eax), %al
0x0000012c:	addb (%eax), %al
0x0000012e:	addb (%eax), %al
0x00000130:	addb (%eax), %al
0x00000132:	addb (%eax), %al
0x00000134:	addb (%eax), %al
0x00000136:	addb (%eax), %al
0x00000138:	addb (%eax), %al
0x0000013a:	addb (%eax), %al
0x0000013c:	addb (%eax), %al
0x0000013e:	addb (%eax), %al
0x00000140:	addb (%eax), %al
0x00000142:	addb (%eax), %al
0x00000144:	addb (%eax), %al
0x00000146:	addb (%eax), %al
0x00000148:	addb (%eax), %al
0x0000014a:	addb (%eax), %al
0x0000014c:	addb (%eax), %al
0x0000014e:	addb (%eax), %al
0x00000150:	addb (%eax), %al
0x00000152:	addb (%eax), %al
0x00000154:	addb (%eax), %al
0x00000156:	addb (%eax), %al
0x00000158:	addb (%eax), %al
0x0000015a:	addb (%eax), %al
0x0000015c:	addb (%eax), %al
0x0000015e:	addb (%eax), %al
0x00000160:	addb (%eax), %al
0x00000162:	addb (%eax), %al
0x00000164:	addb (%eax), %al
0x00000166:	addb (%eax), %al
