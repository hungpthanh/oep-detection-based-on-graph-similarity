...
0x004196c2:	call LoadLibraryA@KERNEL32.DLL
LoadLibraryA@kernel32.dll: API Node	
0x004196c8:	xchgl %ebp, %eax
0x004196c9:	movb %al, (%edi)
0x004196cb:	incl %edi
0x004196cc:	orb %al, %al
0x004196ce:	je 0x004196ac
0x004196d0:	movl %ecx, %edi
0x004196d2:	jns 0x004196db
0x004196db:	pushl %edi
0x004196dc:	decl %eax
0x004196dd:	repn scasb %al, %es:(%edi)
0x004196df:	pushl %ebp
0x004196e0:	call GetProcAddress@KERNEL32.DLL
GetProcAddress@kernel32.dll: API Node	
0x004196e6:	orl %eax, %eax
0x004196e8:	je 7
0x004196ea:	movl (%ebx), %eax
0x004196ec:	addl %ebx, $0x4<UINT8>
0x004196ef:	jmp 0x004196c9
GetProcAddress@KERNEL32.DLL: API Node	
LoadLibraryA@KERNEL32.DLL: API Node	
0x004196d4:	movzwl %eax, (%edi)
0x004196d7:	incl %edi
0x004196d8:	pushl %eax
0x004196d9:	incl %edi
0x004196da:	movl %ecx, $0xaef24857<UINT32>
0x004196f7:	addl %edi, $0x4<UINT8>
0x004196fa:	leal %ebx, -4(%esi)
0x004196fd:	xorl %eax, %eax
0x004196ff:	movb %al, (%edi)
0x00419701:	incl %edi
0x00419702:	orl %eax, %eax
0x00419704:	je 0x00419728
0x00419706:	cmpb %al, $0xffffffef<UINT8>
0x00419708:	ja 0x0041971b
0x0041970a:	addl %ebx, %eax
0x0041970c:	movl %eax, (%ebx)
0x0041970e:	xchgb %ah, %al
0x00419710:	roll %eax, $0x10<UINT8>
0x00419713:	xchgb %ah, %al
0x00419715:	addl %eax, %esi
0x00419717:	movl (%ebx), %eax
0x00419719:	jmp 0x004196fd
0x0041971b:	andb %al, $0xf<UINT8>
0x0041971d:	shll %eax, $0x10<UINT8>
0x00419720:	movw %ax, (%edi)
0x00419723:	addl %edi, $0x2<UINT8>
0x00419726:	jmp 0x0041970a
0x00419728:	movl %ebp, 0x19578(%esi)
0x0041972e:	leal %edi, -4096(%esi)
0x00419734:	movl %ebx, $0x1000<UINT32>
0x00419739:	pushl %eax
0x0041973a:	pushl %esp
0x0041973b:	pushl $0x4<UINT8>
0x0041973d:	pushl %ebx
0x0041973e:	pushl %edi
0x0041973f:	call VirtualProtect@kernel32.dll
VirtualProtect@kernel32.dll: API Node	
0x00419741:	leal %eax, 0x217(%edi)
0x00419747:	andb (%eax), $0x7f<UINT8>
0x0041974a:	andb 0x28(%eax), $0x7f<UINT8>
0x0041974e:	popl %eax
0x0041974f:	pushl %eax
0x00419750:	pushl %esp
0x00419751:	pushl %eax
0x00419752:	pushl %ebx
0x00419753:	pushl %edi
0x00419754:	call VirtualProtect@kernel32.dll
0x00419756:	popl %eax
0x00419757:	popa
0x00419758:	leal %eax, -128(%esp)
0x0041975c:	pushl $0x0<UINT8>
0x0041975e:	cmpl %esp, %eax
0x00419760:	jne 0x0041975c
0x00419762:	subl %esp, $0xffffff80<UINT8>
0x00419765:	jmp 0x0040333c
