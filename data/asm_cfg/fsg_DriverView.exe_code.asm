...
0x004088fd:	movl %eax, %edx
0x004088ff:	pushl $0x318<UINT32>
0x00408904:	movl 0x284(%esi), %eax
0x0040890a:	call 0x0040a304
0x0040890f:	cmpl %eax, %ebx
0x00408911:	popl %ecx
0x00408912:	je 7
0x00408914:	call 0x0040230d
0x0040230d:	pushl %ebp
0x0040230e:	movl %ebp, %esp
0x00402310:	subl %esp, $0xa2c<UINT32>
0x00402316:	pushl %ebx
0x00402317:	pushl %esi
0x00402318:	pushl %edi
0x00402319:	movl %esi, %eax
0x0040231b:	call 0x00405442
0x00405442:	pushl %ebx
0x00405443:	pushl %edi
0x00405444:	pushl %esi
0x00405445:	movl %eax, $0x214<UINT32>
0x0040544a:	movl (%esi), $0x40ba70<UINT32>
0x00405450:	call 0x00403f4c
0x00403f4c:	addl %eax, $0xfffffffc<UINT8>
0x00403f4f:	pushl %eax
0x00403f50:	movl %eax, 0x8(%esp)
0x00403f54:	addl %eax, $0x4<UINT8>
0x00403f57:	pushl $0x0<UINT8>
0x00403f59:	pushl %eax
0x00403f5a:	call 0x0040a2fe
0x0040a2fe:	jmp memset@msvcrt.dll
memset@msvcrt.dll: API Node	
0x00403f5f:	addl %esp, $0xc<UINT8>
0x00403f62:	ret
...
0x004024b6:	pushl $0x40b6fc<UINT32>
0x004024bb:	pushl $0x40b704<UINT32>
0x004024c0:	pushl %eax
0x004024c1:	call MessageBoxA@USER32.dll
MessageBoxA@USER32.dll: API Node	
0x004024c7:	xorl %eax, %eax
0x004024c9:	leave
0x004024ca:	ret

0x00408adb:	incl %eax
0x00408adc:	jmp 0x00408cee
0x00408cee:	popl %edi
0x00408cef:	popl %esi
0x00408cf0:	popl %ebx
0x00408cf1:	movl %esp, %ebp
0x00408cf3:	popl %ebp
0x00408cf4:	ret $0x10<UINT16>

0x0040a4de:	movl %esi, %eax
0x0040a4e0:	movl -124(%ebp), %esi
0x0040a4e3:	cmpl -28(%ebp), %ebx
0x0040a4e6:	jne 7
0x0040a4e8:	pushl %esi
0x0040a4e9:	call exit@msvcrt.dll
