0x0044d000:	movl %ebx, $0x4001d0<UINT32>
0x0044d005:	movl %edi, $0x401000<UINT32>
0x0044d00a:	movl %esi, $0x437fce<UINT32>
0x0044d00f:	pushl %ebx
0x0044d010:	call 0x0044d01f
0x0044d01f:	cld
0x0044d020:	movb %dl, $0xffffff80<UINT8>
0x0044d022:	movsb %es:(%edi), %ds:(%esi)
0x0044d023:	pushl $0x2<UINT8>
0x0044d025:	popl %ebx
0x0044d026:	call 0x0044d015
0x0044d015:	addb %dl, %dl
0x0044d017:	jne 0x0044d01e
0x0044d019:	movb %dl, (%esi)
0x0044d01b:	incl %esi
0x0044d01c:	adcb %dl, %dl
0x0044d01e:	ret

0x0044d029:	jae 0x0044d022
0x0044d02b:	xorl %ecx, %ecx
0x0044d02d:	call 0x0044d015
0x0044d030:	jae 0x0044d04a
0x0044d032:	xorl %eax, %eax
0x0044d034:	call 0x0044d015
0x0044d037:	jae 0x0044d05a
0x0044d039:	movb %bl, $0x2<UINT8>
0x0044d03b:	incl %ecx
0x0044d03c:	movb %al, $0x10<UINT8>
0x0044d03e:	call 0x0044d015
0x0044d041:	adcb %al, %al
0x0044d043:	jae 0x0044d03e
0x0044d045:	jne 0x0044d086
0x0044d086:	pushl %esi
0x0044d087:	movl %esi, %edi
0x0044d089:	subl %esi, %eax
0x0044d08b:	rep movsb %es:(%edi), %ds:(%esi)
0x0044d08d:	popl %esi
0x0044d08e:	jmp 0x0044d026
0x0044d047:	stosb %es:(%edi), %al
0x0044d048:	jmp 0x0044d026
0x0044d04a:	call 0x0044d092
0x0044d092:	incl %ecx
0x0044d093:	call 0x0044d015
0x0044d097:	adcl %ecx, %ecx
0x0044d099:	call 0x0044d015
0x0044d09d:	jb 0x0044d093
0x0044d09f:	ret

0x0044d04f:	subl %ecx, %ebx
0x0044d051:	jne 0x0044d063
0x0044d063:	xchgl %ecx, %eax
0x0044d064:	decl %eax
0x0044d065:	shll %eax, $0x8<UINT8>
0x0044d068:	lodsb %al, %ds:(%esi)
0x0044d069:	call 0x0044d090
0x0044d090:	xorl %ecx, %ecx
0x0044d06e:	cmpl %eax, $0x7d00<UINT32>
0x0044d073:	jae 0x0044d07f
0x0044d075:	cmpb %ah, $0x5<UINT8>
0x0044d078:	jae 0x0044d080
0x0044d07a:	cmpl %eax, $0x7f<UINT8>
0x0044d07d:	ja 0x0044d081
0x0044d07f:	incl %ecx
0x0044d080:	incl %ecx
0x0044d081:	xchgl %ebp, %eax
0x0044d082:	movl %eax, %ebp
0x0044d084:	movb %bl, $0x1<UINT8>
0x0044d053:	call 0x0044d090
0x0044d058:	jmp 0x0044d082
0x0044d05a:	lodsb %al, %ds:(%esi)
0x0044d05b:	shrl %eax
0x0044d05d:	je 0x0044d0a0
0x0044d05f:	adcl %ecx, %ecx
0x0044d061:	jmp 0x0044d07f
0x0044d0a0:	popl %edi
0x0044d0a1:	popl %ebx
0x0044d0a2:	movzwl %edi, (%ebx)
0x0044d0a5:	decl %edi
0x0044d0a6:	je 0x0044d0b0
0x0044d0a8:	decl %edi
0x0044d0a9:	je 0x0044d0be
0x0044d0ab:	shll %edi, $0xc<UINT8>
0x0044d0ae:	jmp 0x0044d0b7
0x0044d0b7:	incl %ebx
0x0044d0b8:	incl %ebx
0x0044d0b9:	jmp 0x0044d00f
0x0044d0b0:	movl %edi, 0x2(%ebx)
0x0044d0b3:	pushl %edi
0x0044d0b4:	addl %ebx, $0x4<UINT8>
0x0044d0be:	popl %edi
0x0044d0bf:	movl %ebx, $0x44d128<UINT32>
0x0044d0c4:	incl %edi
0x0044d0c5:	movl %esi, (%edi)
0x0044d0c7:	scasl %eax, %es:(%edi)
0x0044d0c8:	pushl %edi
0x0044d0c9:	call LoadLibraryA@KERNEL32.dll
LoadLibraryA@kernel32.dll: API Node	
0x0044d0cb:	xchgl %ebp, %eax
0x0044d0cc:	xorl %eax, %eax
0x0044d0ce:	scasb %al, %es:(%edi)
0x0044d0cf:	jne 0x0044d0ce
0x0044d0d1:	decb (%edi)
0x0044d0d3:	je 0x0044d0c4
0x0044d0d5:	decb (%edi)
0x0044d0d7:	jne 0x0044d0df
0x0044d0df:	decb (%edi)
0x0044d0e1:	je 0x00408fd4
0x0044d0e7:	pushl %edi
0x0044d0e8:	pushl %ebp
0x0044d0e9:	call GetProcAddress@KERNEL32.dll
GetProcAddress@kernel32.dll: API Node	
0x0044d0ec:	orl (%esi), %eax
0x0044d0ee:	lodsl %eax, %ds:(%esi)
0x0044d0ef:	jne 0x0044d0cc
0x0044d0d9:	incl %edi
0x0044d0da:	pushl (%edi)
0x0044d0dc:	scasl %eax, %es:(%edi)
0x0044d0dd:	jmp 0x0044d0e8
GetProcAddress@KERNEL32.dll: API Node	
LoadLibraryA@KERNEL32.dll: API Node	
