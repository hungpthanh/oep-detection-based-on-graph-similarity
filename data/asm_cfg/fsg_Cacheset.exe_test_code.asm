...
0x0042f00a:	movl %esi, $0x42645c<UINT32>
...
0x00404c88:	je 197
0x00404c8e:	movl %eax, 0x44(%esp)
0x00404c92:	testl %eax, %eax
0x00404c94:	je 185
0x00404c9a:	movl %esi, (%eax)
0x00404c9c:	leal %ebp, 0x4(%eax)
0x00404c9f:	movl %eax, $0x800<UINT32>
0x00404ca4:	cmpl %esi, %eax
0x00404ca6:	leal %ebx, (%esi,%ebp)
0x00404ca9:	jl 0x00404cad
0x00404cad:	cmpl 0x423300, %esi
0x00404cb3:	jnl 0x00404d07
0x00404d07:	xorl %edi, %edi
0x00404d09:	testl %esi, %esi
0x00404d0b:	jle 0x00404d53
