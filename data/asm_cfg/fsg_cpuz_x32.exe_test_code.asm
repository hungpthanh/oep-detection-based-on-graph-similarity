0x00840000:	movl %ebx, $0x4001d0<UINT32>
0x00840005:	movl %edi, $0x401000<UINT32>
0x0084000a:	movl %esi, $0x71a7e7<UINT32>
0x0084000f:	pushl %ebx
0x00840010:	call 0x0084001f
0x0084001f:	cld
0x00840020:	movb %dl, $0xffffff80<UINT8>
0x00840022:	movsb %es:(%edi), %ds:(%esi)
0x00840023:	pushl $0x2<UINT8>
0x00840025:	popl %ebx
0x00840026:	call 0x00840015
0x00840015:	addb %dl, %dl
0x00840017:	jne 0x0084001e
0x00840019:	movb %dl, (%esi)
0x0084001b:	incl %esi
0x0084001c:	adcb %dl, %dl
0x0084001e:	ret

0x00840029:	jae 0x00840022
0x0084002b:	xorl %ecx, %ecx
0x0084002d:	call 0x00840015
0x00840030:	jae 0x0084004a
0x00840032:	xorl %eax, %eax
0x00840034:	call 0x00840015
0x00840037:	jae 0x0084005a
0x00840039:	movb %bl, $0x2<UINT8>
0x0084003b:	incl %ecx
0x0084003c:	movb %al, $0x10<UINT8>
0x0084003e:	call 0x00840015
0x00840041:	adcb %al, %al
0x00840043:	jae 0x0084003e
0x00840045:	jne 0x00840086
0x00840047:	stosb %es:(%edi), %al
0x00840048:	jmp 0x00840026
0x0084004a:	call 0x00840092
0x00840092:	incl %ecx
0x00840093:	call 0x00840015
0x00840097:	adcl %ecx, %ecx
0x00840099:	call 0x00840015
0x0084009d:	jb 0x00840093
0x0084009f:	ret

0x0084004f:	subl %ecx, %ebx
0x00840051:	jne 0x00840063
0x00840063:	xchgl %ecx, %eax
0x00840064:	decl %eax
0x00840065:	shll %eax, $0x8<UINT8>
0x00840068:	lodsb %al, %ds:(%esi)
0x00840069:	call 0x00840090
0x00840090:	xorl %ecx, %ecx
0x0084006e:	cmpl %eax, $0x7d00<UINT32>
0x00840073:	jae 0x0084007f
0x00840075:	cmpb %ah, $0x5<UINT8>
0x00840078:	jae 0x00840080
0x0084007a:	cmpl %eax, $0x7f<UINT8>
0x0084007d:	ja 0x00840081
0x0084007f:	incl %ecx
0x00840080:	incl %ecx
0x00840081:	xchgl %ebp, %eax
0x00840082:	movl %eax, %ebp
0x00840084:	movb %bl, $0x1<UINT8>
0x00840086:	pushl %esi
0x00840087:	movl %esi, %edi
0x00840089:	subl %esi, %eax
0x0084008b:	rep movsb %es:(%edi), %ds:(%esi)
0x0084008d:	popl %esi
0x0084008e:	jmp 0x00840026
0x00840053:	call 0x00840090
0x00840058:	jmp 0x00840082
0x0084005a:	lodsb %al, %ds:(%esi)
0x0084005b:	shrl %eax
0x0084005d:	je 0x008400a0
0x0084005f:	adcl %ecx, %ecx
0x00840061:	jmp 0x0084007f
0x008400a0:	popl %edi
0x008400a1:	popl %ebx
0x008400a2:	movzwl %edi, (%ebx)
0x008400a5:	decl %edi
0x008400a6:	je 0x008400b0
0x008400a8:	decl %edi
0x008400a9:	je 0x008400be
0x008400ab:	shll %edi, $0xc<UINT8>
0x008400ae:	jmp 0x008400b7
0x008400b7:	incl %ebx
0x008400b8:	incl %ebx
0x008400b9:	jmp 0x0084000f
0x008400b0:	movl %edi, 0x2(%ebx)
0x008400b3:	pushl %edi
0x008400b4:	addl %ebx, $0x4<UINT8>
0x008400be:	popl %edi
0x008400bf:	movl %ebx, $0x840128<UINT32>
0x008400c4:	incl %edi
0x008400c5:	movl %esi, (%edi)
0x008400c7:	scasl %eax, %es:(%edi)
0x008400c8:	pushl %edi
0x008400c9:	call LoadLibraryA@KERNEL32.dll
LoadLibraryA@kernel32.dll: API Node	
0x008400cb:	xchgl %ebp, %eax
0x008400cc:	xorl %eax, %eax
0x008400ce:	scasb %al, %es:(%edi)
0x008400cf:	jne 0x008400ce
0x008400d1:	decb (%edi)
0x008400d3:	je 0x008400c4
0x008400d5:	decb (%edi)
0x008400d7:	jne 0x008400df
0x008400df:	decb (%edi)
0x008400e1:	je 0x004f7c76
0x008400e7:	pushl %edi
0x008400e8:	pushl %ebp
0x008400e9:	call GetProcAddress@KERNEL32.dll
GetProcAddress@kernel32.dll: API Node	
0x008400ec:	orl (%esi), %eax
0x008400ee:	lodsl %eax, %ds:(%esi)
0x008400ef:	jne 0x008400cc
GetProcAddress@KERNEL32.dll: API Node	
LoadLibraryA@KERNEL32.dll: API Node	
0x008400d9:	incl %edi
0x008400da:	pushl (%edi)
0x008400dc:	scasl %eax, %es:(%edi)
0x008400dd:	jmp 0x008400e8
...
0x004fcd68:	jl 2
0x004fcd6a:	movl %edi, %esi
0x004fcd6c:	movl -32(%ebp), $0x1<UINT32>
0x004fcd73:	jmp 0x004fcdd0
0x004fcdd0:	cmpl 0x58b708, %edi
0x004fcdd6:	jl 0x004fcd75
0x004fcd75:	pushl $0x40<UINT8>
0x004fcd77:	pushl $0x20<UINT8>
0x004fcd79:	call 0x0050090e
0x004fcd7e:	popl %ecx
0x004fcd7f:	popl %ecx
0x004fcd80:	testl %eax, %eax
0x004fcd82:	je 86
0x004fcd84:	movl %ecx, -32(%ebp)
0x004fcd87:	leal %ecx, 0x58b720(,%ecx,4)
0x004fcd8e:	movl (%ecx), %eax
0x004fcd90:	addl 0x58b708, $0x20<UINT8>
0x004fcd97:	leal %edx, 0x800(%eax)
0x004fcd9d:	jmp 0x004fcdc9
0x004fcdc9:	cmpl %eax, %edx
0x004fcdcb:	jb 0x004fcd9f
0x004fcd9f:	movb 0x4(%eax), $0x0<UINT8>
0x004fcda3:	orl (%eax), $0xffffffff<UINT8>
0x004fcda6:	movb 0x5(%eax), $0xa<UINT8>
0x004fcdaa:	andl 0x8(%eax), $0x0<UINT8>
0x004fcdae:	andb 0x24(%eax), $0xffffff80<UINT8>
0x004fcdb2:	movb 0x25(%eax), $0xa<UINT8>
0x004fcdb6:	movb 0x26(%eax), $0xa<UINT8>
0x004fcdba:	andl 0x38(%eax), $0x0<UINT8>
0x004fcdbe:	movb 0x34(%eax), $0x0<UINT8>
0x004fcdc2:	addl %eax, $0x40<UINT8>
0x004fcdc5:	movl %edx, (%ecx)
0x004fcdc7:	addl %edx, %esi
0x004fcdcd:	incl -32(%ebp)
0x004fcdd8:	jmp 0x004fcde0
0x004fcde0:	andl -32(%ebp), $0x0<UINT8>
0x004fcde4:	testl %edi, %edi
0x004fcde6:	jle 109
0x004fcde8:	movl %eax, -28(%ebp)
0x004fcdeb:	movl %ecx, (%eax)
0x004fcded:	cmpl %ecx, $0xffffffff<UINT8>
0x004fcdf0:	je 86
0x004fcdf2:	cmpl %ecx, $0xfffffffe<UINT8>
0x004fcdf5:	je 81
0x004fcdf7:	movb %al, (%ebx)
0x004fcdf9:	testb %al, $0x1<UINT8>
0x004fcdfb:	je 0x004fce48
0x004fce48:	incl -32(%ebp)
0x004fce4b:	incl %ebx
0x004fce4c:	addl -28(%ebp), $0x4<UINT8>
0x004fce50:	cmpl -32(%ebp), %edi
0x004fce53:	jl 0x004fcde8
0x004fcdfd:	testb %al, $0x8<UINT8>
0x004fcdff:	jne 0x004fce0c
0x004fce0c:	movl %esi, -32(%ebp)
0x004fce0f:	movl %eax, %esi
0x004fce11:	sarl %eax, $0x5<UINT8>
0x004fce14:	andl %esi, $0x1f<UINT8>
0x004fce17:	shll %esi, $0x6<UINT8>
0x004fce1a:	addl %esi, 0x58b720(,%eax,4)
0x004fce21:	movl %eax, -28(%ebp)
0x004fce24:	movl %eax, (%eax)
0x004fce26:	movl (%esi), %eax
0x004fce28:	movb %al, (%ebx)
0x004fce2a:	movb 0x4(%esi), %al
0x004fce2d:	pushl $0xfa0<UINT32>
0x004fce32:	leal %eax, 0xc(%esi)
0x004fce35:	pushl %eax
0x004fce36:	call 0x00508bfc
0x004fce3b:	popl %ecx
0x004fce3c:	popl %ecx
0x004fce3d:	testl %eax, %eax
0x004fce3f:	je 201
0x004fce45:	incl 0x8(%esi)
0x004fce01:	pushl %ecx
0x004fce02:	call GetFileType@KERNEL32.dll
GetFileType@KERNEL32.dll: API Node	
0x004fce08:	testl %eax, %eax
0x004fce0a:	je 0x004fce48
...
0x004fce69:	cmpl %eax, $0xfffffffe<UINT8>
0x004fce6c:	je 6
0x004fce6e:	orb 0x4(%esi), $0xffffff80<UINT8>
0x004fce72:	jmp 0x004fcee6
