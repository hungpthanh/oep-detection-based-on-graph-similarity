0x00426080:	pusha
0x00426081:	movl %esi, $0x41e000<UINT32>
0x00426086:	leal %edi, -118784(%esi)
0x0042608c:	pushl %edi
0x0042608d:	jmp 0x0042609a
0x0042609a:	movl %ebx, (%esi)
0x0042609c:	subl %esi, $0xfffffffc<UINT8>
0x0042609f:	adcl %ebx, %ebx
0x004260a1:	jb 0x00426090
0x00426090:	movb %al, (%esi)
0x00426092:	incl %esi
0x00426093:	movb (%edi), %al
0x00426095:	incl %edi
0x00426096:	addl %ebx, %ebx
0x00426098:	jne 0x004260a1
0x004260a3:	movl %eax, $0x1<UINT32>
0x004260a8:	addl %ebx, %ebx
0x004260aa:	jne 0x004260b3
0x004260b3:	adcl %eax, %eax
0x004260b5:	addl %ebx, %ebx
0x004260b7:	jae 0x004260a8
0x004260b9:	jne 0x004260c4
0x004260c4:	xorl %ecx, %ecx
0x004260c6:	subl %eax, $0x3<UINT8>
0x004260c9:	jb 0x004260d8
0x004260cb:	shll %eax, $0x8<UINT8>
0x004260ce:	movb %al, (%esi)
0x004260d0:	incl %esi
0x004260d1:	xorl %eax, $0xffffffff<UINT8>
0x004260d4:	je 0x0042614a
0x004260d6:	movl %ebp, %eax
0x004260d8:	addl %ebx, %ebx
0x004260da:	jne 0x004260e3
0x004260e3:	adcl %ecx, %ecx
0x004260e5:	addl %ebx, %ebx
0x004260e7:	jne 0x004260f0
0x004260f0:	adcl %ecx, %ecx
0x004260f2:	jne 0x00426114
0x00426114:	cmpl %ebp, $0xfffff300<UINT32>
0x0042611a:	adcl %ecx, $0x1<UINT8>
0x0042611d:	leal %edx, (%edi,%ebp)
0x00426120:	cmpl %ebp, $0xfffffffc<UINT8>
0x00426123:	jbe 0x00426134
0x00426134:	movl %eax, (%edx)
0x00426136:	addl %edx, $0x4<UINT8>
0x00426139:	movl (%edi), %eax
0x0042613b:	addl %edi, $0x4<UINT8>
0x0042613e:	subl %ecx, $0x4<UINT8>
0x00426141:	ja 0x00426134
0x00426143:	addl %edi, %ecx
0x00426145:	jmp 0x00426096
0x004260dc:	movl %ebx, (%esi)
0x004260de:	subl %esi, $0xfffffffc<UINT8>
0x004260e1:	adcl %ebx, %ebx
0x004260f4:	incl %ecx
0x004260f5:	addl %ebx, %ebx
0x004260f7:	jne 0x00426100
0x00426100:	adcl %ecx, %ecx
0x00426102:	addl %ebx, %ebx
0x00426104:	jae 0x004260f5
0x00426106:	jne 0x00426111
0x00426111:	addl %ecx, $0x2<UINT8>
0x00426108:	movl %ebx, (%esi)
0x0042610a:	subl %esi, $0xfffffffc<UINT8>
0x0042610d:	adcl %ebx, %ebx
0x0042610f:	jae 0x004260f5
0x004260e9:	movl %ebx, (%esi)
0x004260eb:	subl %esi, $0xfffffffc<UINT8>
0x004260ee:	adcl %ebx, %ebx
0x004260ac:	movl %ebx, (%esi)
0x004260ae:	subl %esi, $0xfffffffc<UINT8>
0x004260b1:	adcl %ebx, %ebx
0x004260bb:	movl %ebx, (%esi)
0x004260bd:	subl %esi, $0xfffffffc<UINT8>
0x004260c0:	adcl %ebx, %ebx
0x004260c2:	jae 0x004260a8
0x00426125:	movb %al, (%edx)
0x00426127:	incl %edx
0x00426128:	movb (%edi), %al
0x0042612a:	incl %edi
0x0042612b:	decl %ecx
0x0042612c:	jne 0x00426125
0x0042612e:	jmp 0x00426096
0x004260f9:	movl %ebx, (%esi)
0x004260fb:	subl %esi, $0xfffffffc<UINT8>
0x004260fe:	adcl %ebx, %ebx
0x0042614a:	popl %esi
0x0042614b:	movl %edi, %esi
0x0042614d:	movl %ecx, $0x15c<UINT32>
0x00426152:	movb %al, (%edi)
0x00426154:	incl %edi
0x00426155:	subb %al, $0xffffffe8<UINT8>
0x00426157:	cmpb %al, $0x1<UINT8>
0x00426159:	ja 0x00426152
0x0042615b:	cmpb (%edi), $0x6<UINT8>
0x0042615e:	jne 0x00426152
0x00426160:	movl %eax, (%edi)
0x00426162:	movb %bl, 0x4(%edi)
0x00426165:	shrw %ax, $0x8<UINT8>
0x00426169:	roll %eax, $0x10<UINT8>
0x0042616c:	xchgb %ah, %al
0x0042616e:	subl %eax, %edi
0x00426170:	subb %bl, $0xffffffe8<UINT8>
0x00426173:	addl %eax, %esi
0x00426175:	movl (%edi), %eax
0x00426177:	addl %edi, $0x5<UINT8>
0x0042617a:	movb %al, %bl
0x0042617c:	loop 0x00426157
0x0042617e:	leal %edi, 0x24000(%esi)
0x00426184:	movl %eax, (%edi)
0x00426186:	orl %eax, %eax
0x00426188:	je 0x004261cf
0x0042618a:	movl %ebx, 0x4(%edi)
0x0042618d:	leal %eax, 0x26000(%eax,%esi)
0x00426194:	addl %ebx, %esi
0x00426196:	pushl %eax
0x00426197:	addl %edi, $0x8<UINT8>
0x0042619a:	call LoadLibraryA@KERNEL32.DLL
LoadLibraryA@kernel32.dll: API Node	
0x004261a0:	xchgl %ebp, %eax
0x004261a1:	movb %al, (%edi)
0x004261a3:	incl %edi
0x004261a4:	orb %al, %al
0x004261a6:	je 0x00426184
0x004261a8:	movl %ecx, %edi
0x004261aa:	jns 0x004261b3
0x004261b3:	pushl %edi
0x004261b4:	decl %eax
0x004261b5:	repn scasb %al, %es:(%edi)
0x004261b7:	pushl %ebp
0x004261b8:	call GetProcAddress@KERNEL32.DLL
GetProcAddress@kernel32.dll: API Node	
0x004261be:	orl %eax, %eax
0x004261c0:	je 7
0x004261c2:	movl (%ebx), %eax
0x004261c4:	addl %ebx, $0x4<UINT8>
0x004261c7:	jmp 0x004261a1
GetProcAddress@KERNEL32.DLL: API Node	
LoadLibraryA@KERNEL32.DLL: API Node	
0x004261ac:	movzwl %eax, (%edi)
0x004261af:	incl %edi
0x004261b0:	pushl %eax
0x004261b1:	incl %edi
0x004261b2:	movl %ecx, $0xaef24857<UINT32>
0x004261cf:	movl %ebp, 0x260f4(%esi)
0x004261d5:	leal %edi, -4096(%esi)
0x004261db:	movl %ebx, $0x1000<UINT32>
0x004261e0:	pushl %eax
0x004261e1:	pushl %esp
0x004261e2:	pushl $0x4<UINT8>
0x004261e4:	pushl %ebx
0x004261e5:	pushl %edi
0x004261e6:	call VirtualProtect@kernel32.dll
VirtualProtect@kernel32.dll: API Node	
0x004261e8:	leal %eax, 0x20f(%edi)
0x004261ee:	andb (%eax), $0x7f<UINT8>
0x004261f1:	andb 0x28(%eax), $0x7f<UINT8>
0x004261f5:	popl %eax
0x004261f6:	pushl %eax
0x004261f7:	pushl %esp
0x004261f8:	pushl %eax
0x004261f9:	pushl %ebx
0x004261fa:	pushl %edi
0x004261fb:	call VirtualProtect@kernel32.dll
0x004261fd:	popl %eax
0x004261fe:	popa
0x004261ff:	leal %eax, -128(%esp)
0x00426203:	pushl $0x0<UINT8>
0x00426205:	cmpl %esp, %eax
0x00426207:	jne 0x00426203
0x00426209:	subl %esp, $0xffffff80<UINT8>
0x0042620c:	jmp 0x00402471
