...
0x01693e17:	leal %edi, 0x128f000(%esi)
0x01693e1d:	movl %eax, (%edi)
0x01693e1f:	orl %eax, %eax
0x01693e21:	je 69
0x01693e23:	movl %ebx, 0x4(%edi)
0x01693e26:	leal %eax, 0x12b18a0(%eax,%esi)
0x01693e2d:	addl %ebx, %esi
0x01693e2f:	pushl %eax
0x01693e30:	addl %edi, $0x8<UINT8>
0x01693e33:	call 0x00000000
