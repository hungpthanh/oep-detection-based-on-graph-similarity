...
0x0041ab7b:	je 10
0x0041ab7d:	pushl 0x8(%ebp)
0x0041ab80:	call 0x004144a3
0x004144a3:	movl %edi, %edi
0x004144a5:	pushl %ebp
0x004144a6:	movl %ebp, %esp
0x004144a8:	call 0x0041442e
0x0041442e:	movl %eax, $0x41db41<UINT32>
0x00414433:	movl 0x43e3d0, %eax
0x00414438:	movl 0x43e3d4, $0x41d1cb<UINT32>
0x00414442:	movl 0x43e3d8, $0x41d17f<UINT32>
0x0041444c:	movl 0x43e3dc, $0x41d1b8<UINT32>
0x00414456:	movl 0x43e3e0, $0x41d121<UINT32>
0x00414460:	movl 0x43e3e4, %eax
0x00414465:	movl 0x43e3e8, $0x41dab9<UINT32>
0x0041446f:	movl 0x43e3ec, $0x41d13d<UINT32>
0x00414479:	movl 0x43e3f0, $0x41d09f<UINT32>
0x00414483:	movl 0x43e3f4, $0x41d02c<UINT32>
0x0041448d:	ret

0x004144ad:	call 0x0041dbee
0x0041dbee:	pushl $0x4396f4<UINT32>
0x0041dbf3:	call GetModuleHandleA@KERNEL32.DLL
GetModuleHandleA@KERNEL32.DLL: API Node	
0x0041dbf9:	testl %eax, %eax
0x0041dbfb:	je 21
0x0041dbfd:	pushl $0x4396d8<UINT32>
0x0041dc02:	pushl %eax
0x0041dc03:	call GetProcAddress@KERNEL32.DLL
0x0041dc09:	testl %eax, %eax
0x0041dc0b:	je 5
0x0041dc0d:	pushl $0x0<UINT8>
0x0041dc0f:	call IsProcessorFeaturePresent@KERNEL32
IsProcessorFeaturePresent@KERNEL32: API Node	
0x0041dc11:	ret

0x004144b2:	cmpl 0x8(%ebp), $0x0<UINT8>
0x004144b6:	movl 0x447604, %eax
0x004144bb:	je 5
0x004144bd:	call 0x0041db85
0x0041db85:	movl %edi, %edi
0x0041db87:	pushl %esi
0x0041db88:	pushl $0x30000<UINT32>
0x0041db8d:	pushl $0x10000<UINT32>
0x0041db92:	xorl %esi, %esi
0x0041db94:	pushl %esi
0x0041db95:	call 0x0042c8c8
0x0042c8c8:	movl %edi, %edi
0x0042c8ca:	pushl %ebp
0x0042c8cb:	movl %ebp, %esp
0x0042c8cd:	movl %eax, 0x10(%ebp)
0x0042c8d0:	movl %ecx, 0xc(%ebp)
0x0042c8d3:	andl %eax, $0xfff7ffff<UINT32>
0x0042c8d8:	andl %ecx, %eax
0x0042c8da:	pushl %esi
0x0042c8db:	testl %ecx, $0xfcf0fce0<UINT32>
0x0042c8e1:	je 0x0042c914
0x0042c914:	movl %esi, 0x8(%ebp)
0x0042c917:	pushl %eax
0x0042c918:	pushl 0xc(%ebp)
0x0042c91b:	testl %esi, %esi
0x0042c91d:	je 0x0042c928
0x0042c928:	call 0x00431cf4
0x00431cf4:	movl %edi, %edi
0x00431cf6:	pushl %ebp
0x00431cf7:	movl %ebp, %esp
0x00431cf9:	subl %esp, $0x14<UINT8>
0x00431cfc:	pushl %ebx
0x00431cfd:	pushl %esi
0x00431cfe:	pushl %edi
0x00431cff:	fwait
0x00431d00:	fnstcw -8(%ebp)
0x00431d03:	movl %ebx, -8(%ebp)
0x00431d06:	xorl %edx, %edx
0x00431d08:	testb %bl, $0x1<UINT8>
0x00431d0b:	je 0x00431d10
0x00431d10:	testb %bl, $0x4<UINT8>
0x00431d13:	je 3
0x00431d15:	orl %edx, $0x8<UINT8>
0x00431d18:	testb %bl, $0x8<UINT8>
0x00431d1b:	je 3
0x00431d1d:	orl %edx, $0x4<UINT8>
0x00431d20:	testb %bl, $0x10<UINT8>
0x00431d23:	je 0x00431d28
0x00431d28:	testb %bl, $0x20<UINT8>
0x00431d2b:	je 3
0x00431d2d:	orl %edx, $0x1<UINT8>
0x00431d30:	testb %bl, $0x2<UINT8>
0x00431d33:	je 0x00431d3b
0x00431d3b:	movzwl %ecx, %bx
0x00431d3e:	movl %eax, %ecx
0x00431d40:	movl %esi, $0xc00<UINT32>
0x00431d45:	andl %eax, %esi
0x00431d47:	movl %edi, $0x300<UINT32>
0x00431d4c:	je 36
0x00431d4e:	cmpl %eax, $0x400<UINT32>
0x00431d53:	je 23
0x00431d55:	cmpl %eax, $0x800<UINT32>
0x00431d5a:	je 8
0x00431d5c:	cmpl %eax, %esi
0x00431d5e:	jne 18
0x00431d60:	orl %edx, %edi
0x00431d62:	jmp 0x00431d72
0x00431d72:	andl %ecx, %edi
0x00431d74:	je 16
0x00431d76:	cmpl %ecx, $0x200<UINT32>
0x00431d7c:	jne 14
0x00431d7e:	orl %edx, $0x10000<UINT32>
0x00431d84:	jmp 0x00431d8c
0x00431d8c:	testl %ebx, $0x1000<UINT32>
0x00431d92:	je 6
0x00431d94:	orl %edx, $0x40000<UINT32>
0x00431d9a:	movl %edi, 0xc(%ebp)
0x00431d9d:	movl %ecx, 0x8(%ebp)
0x00431da0:	movl %eax, %edi
0x00431da2:	notl %eax
0x00431da4:	andl %eax, %edx
0x00431da6:	andl %ecx, %edi
0x00431da8:	orl %eax, %ecx
0x00431daa:	movl 0xc(%ebp), %eax
0x00431dad:	cmpl %eax, %edx
0x00431daf:	je 0x00431e63
0x00431e63:	xorl %esi, %esi
0x00431e65:	cmpl 0x4548a0, %esi
0x00431e6b:	je 0x00431ffe
0x00431ffe:	popl %edi
0x00431fff:	popl %esi
0x00432000:	popl %ebx
0x00432001:	leave
...
0x0042c92d:	popl %ecx
0x0042c92e:	popl %ecx
0x0042c92f:	xorl %eax, %eax
0x0042c931:	popl %esi
0x0042c932:	popl %ebp
0x0042c933:	ret

0x0041db9a:	addl %esp, $0xc<UINT8>
0x0041db9d:	testl %eax, %eax
0x0041db9f:	je 0x0041dbae
0x0041dbae:	popl %esi
0x0041dbaf:	ret
