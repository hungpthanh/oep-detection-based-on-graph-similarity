0x00425130:	pusha
0x00425131:	movl %esi, $0x418000<UINT32>
0x00425136:	leal %edi, -94208(%esi)
0x0042513c:	pushl %edi
0x0042513d:	orl %ebp, $0xffffffff<UINT8>
0x00425140:	jmp 0x00425152
0x00425152:	movl %ebx, (%esi)
0x00425154:	subl %esi, $0xfffffffc<UINT8>
0x00425157:	adcl %ebx, %ebx
0x00425159:	jb 0x00425148
0x00425148:	movb %al, (%esi)
0x0042514a:	incl %esi
0x0042514b:	movb (%edi), %al
0x0042514d:	incl %edi
0x0042514e:	addl %ebx, %ebx
0x00425150:	jne 0x00425159
0x0042515b:	movl %eax, $0x1<UINT32>
0x00425160:	addl %ebx, %ebx
0x00425162:	jne 0x0042516b
0x0042516b:	adcl %eax, %eax
0x0042516d:	addl %ebx, %ebx
0x0042516f:	jae 0x00425160
0x00425171:	jne 0x0042517c
0x0042517c:	xorl %ecx, %ecx
0x0042517e:	subl %eax, $0x3<UINT8>
0x00425181:	jb 0x00425190
0x00425190:	addl %ebx, %ebx
0x00425192:	jne 0x0042519b
0x0042519b:	adcl %ecx, %ecx
0x0042519d:	addl %ebx, %ebx
0x0042519f:	jne 0x004251a8
0x004251a8:	adcl %ecx, %ecx
0x004251aa:	jne 0x004251cc
0x004251cc:	cmpl %ebp, $0xfffff300<UINT32>
0x004251d2:	adcl %ecx, $0x1<UINT8>
0x004251d5:	leal %edx, (%edi,%ebp)
0x004251d8:	cmpl %ebp, $0xfffffffc<UINT8>
0x004251db:	jbe 0x004251ec
0x004251dd:	movb %al, (%edx)
0x004251df:	incl %edx
0x004251e0:	movb (%edi), %al
0x004251e2:	incl %edi
0x004251e3:	decl %ecx
0x004251e4:	jne 0x004251dd
0x004251e6:	jmp 0x0042514e
0x00425183:	shll %eax, $0x8<UINT8>
0x00425186:	movb %al, (%esi)
0x00425188:	incl %esi
0x00425189:	xorl %eax, $0xffffffff<UINT8>
0x0042518c:	je 0x00425202
0x0042518e:	movl %ebp, %eax
0x004251ec:	movl %eax, (%edx)
0x004251ee:	addl %edx, $0x4<UINT8>
0x004251f1:	movl (%edi), %eax
0x004251f3:	addl %edi, $0x4<UINT8>
0x004251f6:	subl %ecx, $0x4<UINT8>
0x004251f9:	ja 0x004251ec
0x004251fb:	addl %edi, %ecx
0x004251fd:	jmp 0x0042514e
0x00425164:	movl %ebx, (%esi)
0x00425166:	subl %esi, $0xfffffffc<UINT8>
0x00425169:	adcl %ebx, %ebx
0x004251ac:	incl %ecx
0x004251ad:	addl %ebx, %ebx
0x004251af:	jne 0x004251b8
0x004251b8:	adcl %ecx, %ecx
0x004251ba:	addl %ebx, %ebx
0x004251bc:	jae 0x004251ad
0x004251be:	jne 0x004251c9
0x004251c9:	addl %ecx, $0x2<UINT8>
0x00425194:	movl %ebx, (%esi)
0x00425196:	subl %esi, $0xfffffffc<UINT8>
0x00425199:	adcl %ebx, %ebx
0x004251b1:	movl %ebx, (%esi)
0x004251b3:	subl %esi, $0xfffffffc<UINT8>
0x004251b6:	adcl %ebx, %ebx
0x004251c0:	movl %ebx, (%esi)
0x004251c2:	subl %esi, $0xfffffffc<UINT8>
0x004251c5:	adcl %ebx, %ebx
0x004251c7:	jae 0x004251ad
0x004251a1:	movl %ebx, (%esi)
0x004251a3:	subl %esi, $0xfffffffc<UINT8>
0x004251a6:	adcl %ebx, %ebx
0x00425173:	movl %ebx, (%esi)
0x00425175:	subl %esi, $0xfffffffc<UINT8>
0x00425178:	adcl %ebx, %ebx
0x0042517a:	jae 0x00425160
0x00425202:	popl %esi
0x00425203:	movl %edi, %esi
0x00425205:	movl %ecx, $0x5e3<UINT32>
0x0042520a:	movb %al, (%edi)
0x0042520c:	incl %edi
0x0042520d:	subb %al, $0xffffffe8<UINT8>
0x0042520f:	cmpb %al, $0x1<UINT8>
0x00425211:	ja 0x0042520a
0x00425213:	cmpb (%edi), $0x9<UINT8>
0x00425216:	jne 0x0042520a
0x00425218:	movl %eax, (%edi)
0x0042521a:	movb %bl, 0x4(%edi)
0x0042521d:	shrw %ax, $0x8<UINT8>
0x00425221:	roll %eax, $0x10<UINT8>
0x00425224:	xchgb %ah, %al
0x00425226:	subl %eax, %edi
0x00425228:	subb %bl, $0xffffffe8<UINT8>
0x0042522b:	addl %eax, %esi
0x0042522d:	movl (%edi), %eax
0x0042522f:	addl %edi, $0x5<UINT8>
0x00425232:	movb %al, %bl
0x00425234:	loop 0x0042520f
0x00425236:	leal %edi, 0x23000(%esi)
0x0042523c:	movl %eax, (%edi)
0x0042523e:	orl %eax, %eax
0x00425240:	je 0x0042527e
0x00425242:	movl %ebx, 0x4(%edi)
0x00425245:	leal %eax, 0x25540(%eax,%esi)
0x0042524c:	addl %ebx, %esi
0x0042524e:	pushl %eax
0x0042524f:	addl %edi, $0x8<UINT8>
0x00425252:	call LoadLibraryA@kernel32.dll
LoadLibraryA@kernel32.dll: API Node	
0x00425258:	xchgl %ebp, %eax
0x00425259:	movb %al, (%edi)
0x0042525b:	incl %edi
0x0042525c:	orb %al, %al
0x0042525e:	je 0x0042523c
0x00425260:	movl %ecx, %edi
0x00425262:	pushl %edi
0x00425263:	decl %eax
0x00425264:	repn scasb %al, %es:(%edi)
0x00425266:	pushl %ebp
0x00425267:	call GetProcAddress@KERNEL32.DLL
GetProcAddress@kernel32.dll: API Node	
0x0042526d:	orl %eax, %eax
0x0042526f:	je 7
0x00425271:	movl (%ebx), %eax
0x00425273:	addl %ebx, $0x4<UINT8>
0x00425276:	jmp 0x00425259
GetProcAddress@KERNEL32.DLL: API Node	
0x0042527e:	movl %ebp, 0x255f0(%esi)
0x00425284:	leal %edi, -4096(%esi)
0x0042528a:	movl %ebx, $0x1000<UINT32>
0x0042528f:	pushl %eax
0x00425290:	pushl %esp
0x00425291:	pushl $0x4<UINT8>
0x00425293:	pushl %ebx
0x00425294:	pushl %edi
0x00425295:	call VirtualProtect@kernel32.dll
VirtualProtect@kernel32.dll: API Node	
0x00425297:	leal %eax, 0x20f(%edi)
0x0042529d:	andb (%eax), $0x7f<UINT8>
0x004252a0:	andb 0x28(%eax), $0x7f<UINT8>
0x004252a4:	popl %eax
0x004252a5:	pushl %eax
0x004252a6:	pushl %esp
0x004252a7:	pushl %eax
0x004252a8:	pushl %ebx
0x004252a9:	pushl %edi
0x004252aa:	call VirtualProtect@kernel32.dll
0x004252ac:	popl %eax
0x004252ad:	popa
0x004252ae:	leal %eax, -128(%esp)
0x004252b2:	pushl $0x0<UINT8>
0x004252b4:	cmpl %esp, %eax
0x004252b6:	jne 0x004252b2
0x004252b8:	subl %esp, $0xffffff80<UINT8>
0x004252bb:	jmp 0x0040570c
