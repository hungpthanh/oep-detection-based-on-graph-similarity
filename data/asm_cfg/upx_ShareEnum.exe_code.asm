0x00442540:	pusha
0x00442541:	movl %esi, $0x42f000<UINT32>
0x00442546:	leal %edi, -188416(%esi)
0x0044254c:	pushl %edi
0x0044254d:	jmp 0x0044255a
0x0044255a:	movl %ebx, (%esi)
0x0044255c:	subl %esi, $0xfffffffc<UINT8>
0x0044255f:	adcl %ebx, %ebx
0x00442561:	jb 0x00442550
0x00442550:	movb %al, (%esi)
0x00442552:	incl %esi
0x00442553:	movb (%edi), %al
0x00442555:	incl %edi
0x00442556:	addl %ebx, %ebx
0x00442558:	jne 0x00442561
0x00442563:	movl %eax, $0x1<UINT32>
0x00442568:	addl %ebx, %ebx
0x0044256a:	jne 0x00442573
0x00442573:	adcl %eax, %eax
0x00442575:	addl %ebx, %ebx
0x00442577:	jae 0x00442568
0x00442579:	jne 0x00442584
0x00442584:	xorl %ecx, %ecx
0x00442586:	subl %eax, $0x3<UINT8>
0x00442589:	jb 0x00442598
0x0044258b:	shll %eax, $0x8<UINT8>
0x0044258e:	movb %al, (%esi)
0x00442590:	incl %esi
0x00442591:	xorl %eax, $0xffffffff<UINT8>
0x00442594:	je 0x0044260a
0x00442596:	movl %ebp, %eax
0x00442598:	addl %ebx, %ebx
0x0044259a:	jne 0x004425a3
0x004425a3:	adcl %ecx, %ecx
0x004425a5:	addl %ebx, %ebx
0x004425a7:	jne 0x004425b0
0x004425b0:	adcl %ecx, %ecx
0x004425b2:	jne 0x004425d4
0x004425d4:	cmpl %ebp, $0xfffff300<UINT32>
0x004425da:	adcl %ecx, $0x1<UINT8>
0x004425dd:	leal %edx, (%edi,%ebp)
0x004425e0:	cmpl %ebp, $0xfffffffc<UINT8>
0x004425e3:	jbe 0x004425f4
0x004425f4:	movl %eax, (%edx)
0x004425f6:	addl %edx, $0x4<UINT8>
0x004425f9:	movl (%edi), %eax
0x004425fb:	addl %edi, $0x4<UINT8>
0x004425fe:	subl %ecx, $0x4<UINT8>
0x00442601:	ja 0x004425f4
0x00442603:	addl %edi, %ecx
0x00442605:	jmp 0x00442556
0x004425b4:	incl %ecx
0x004425b5:	addl %ebx, %ebx
0x004425b7:	jne 0x004425c0
0x004425c0:	adcl %ecx, %ecx
0x004425c2:	addl %ebx, %ebx
0x004425c4:	jae 0x004425b5
0x004425c6:	jne 0x004425d1
0x004425d1:	addl %ecx, $0x2<UINT8>
0x0044257b:	movl %ebx, (%esi)
0x0044257d:	subl %esi, $0xfffffffc<UINT8>
0x00442580:	adcl %ebx, %ebx
0x00442582:	jae 0x00442568
0x004425c8:	movl %ebx, (%esi)
0x004425ca:	subl %esi, $0xfffffffc<UINT8>
0x004425cd:	adcl %ebx, %ebx
0x004425cf:	jae 0x004425b5
0x004425a9:	movl %ebx, (%esi)
0x004425ab:	subl %esi, $0xfffffffc<UINT8>
0x004425ae:	adcl %ebx, %ebx
0x0044259c:	movl %ebx, (%esi)
0x0044259e:	subl %esi, $0xfffffffc<UINT8>
0x004425a1:	adcl %ebx, %ebx
0x004425e5:	movb %al, (%edx)
0x004425e7:	incl %edx
0x004425e8:	movb (%edi), %al
0x004425ea:	incl %edi
0x004425eb:	decl %ecx
0x004425ec:	jne 0x004425e5
0x004425ee:	jmp 0x00442556
0x004425b9:	movl %ebx, (%esi)
0x004425bb:	subl %esi, $0xfffffffc<UINT8>
0x004425be:	adcl %ebx, %ebx
0x0044256c:	movl %ebx, (%esi)
0x0044256e:	subl %esi, $0xfffffffc<UINT8>
0x00442571:	adcl %ebx, %ebx
0x0044260a:	popl %esi
0x0044260b:	movl %edi, %esi
0x0044260d:	movl %ecx, $0x748<UINT32>
0x00442612:	movb %al, (%edi)
0x00442614:	incl %edi
0x00442615:	subb %al, $0xffffffe8<UINT8>
0x00442617:	cmpb %al, $0x1<UINT8>
0x00442619:	ja 0x00442612
0x0044261b:	cmpb (%edi), $0x12<UINT8>
0x0044261e:	jne 0x00442612
0x00442620:	movl %eax, (%edi)
0x00442622:	movb %bl, 0x4(%edi)
0x00442625:	shrw %ax, $0x8<UINT8>
0x00442629:	roll %eax, $0x10<UINT8>
0x0044262c:	xchgb %ah, %al
0x0044262e:	subl %eax, %edi
0x00442630:	subb %bl, $0xffffffe8<UINT8>
0x00442633:	addl %eax, %esi
0x00442635:	movl (%edi), %eax
0x00442637:	addl %edi, $0x5<UINT8>
0x0044263a:	movb %al, %bl
0x0044263c:	loop 0x00442617
0x0044263e:	leal %edi, 0x3f000(%esi)
0x00442644:	movl %eax, (%edi)
0x00442646:	orl %eax, %eax
0x00442648:	je 0x0044268f
0x0044264a:	movl %ebx, 0x4(%edi)
0x0044264d:	leal %eax, 0x42ab0(%eax,%esi)
0x00442654:	addl %ebx, %esi
0x00442656:	pushl %eax
0x00442657:	addl %edi, $0x8<UINT8>
0x0044265a:	call LoadLibraryA@KERNEL32.DLL
LoadLibraryA@kernel32.dll: API Node	
0x00442660:	xchgl %ebp, %eax
0x00442661:	movb %al, (%edi)
0x00442663:	incl %edi
0x00442664:	orb %al, %al
0x00442666:	je 0x00442644
0x00442668:	movl %ecx, %edi
0x0044266a:	jns 0x00442673
0x00442673:	pushl %edi
0x00442674:	decl %eax
0x00442675:	repn scasb %al, %es:(%edi)
0x00442677:	pushl %ebp
0x00442678:	call GetProcAddress@KERNEL32.DLL
GetProcAddress@kernel32.dll: API Node	
0x0044267e:	orl %eax, %eax
0x00442680:	je 7
0x00442682:	movl (%ebx), %eax
0x00442684:	addl %ebx, $0x4<UINT8>
0x00442687:	jmp 0x00442661
GetProcAddress@KERNEL32.DLL: API Node	
LoadLibraryA@KERNEL32.DLL: API Node	
0x0044266c:	movzwl %eax, (%edi)
0x0044266f:	incl %edi
0x00442670:	pushl %eax
0x00442671:	incl %edi
0x00442672:	movl %ecx, $0xaef24857<UINT32>
0x0044268f:	movl %ebp, 0x42bcc(%esi)
0x00442695:	leal %edi, -4096(%esi)
0x0044269b:	movl %ebx, $0x1000<UINT32>
0x004426a0:	pushl %eax
0x004426a1:	pushl %esp
0x004426a2:	pushl $0x4<UINT8>
0x004426a4:	pushl %ebx
0x004426a5:	pushl %edi
0x004426a6:	call VirtualProtect@kernel32.dll
VirtualProtect@kernel32.dll: API Node	
0x004426a8:	leal %eax, 0x21f(%edi)
0x004426ae:	andb (%eax), $0x7f<UINT8>
0x004426b1:	andb 0x28(%eax), $0x7f<UINT8>
0x004426b5:	popl %eax
0x004426b6:	pushl %eax
0x004426b7:	pushl %esp
0x004426b8:	pushl %eax
0x004426b9:	pushl %ebx
0x004426ba:	pushl %edi
0x004426bb:	call VirtualProtect@kernel32.dll
0x004426bd:	popl %eax
0x004426be:	popa
0x004426bf:	leal %eax, -128(%esp)
0x004426c3:	pushl $0x0<UINT8>
0x004426c5:	cmpl %esp, %eax
0x004426c7:	jne 0x004426c3
0x004426c9:	subl %esp, $0xffffff80<UINT8>
0x004426cc:	jmp 0x00409013
